...
function normalizePartyProgressSnapshot(value) {
  ...
  return {
    ...
    theme: /^(?:light|dark|(?:laika|leonard|orca|nox|luna|mishka|puchitsa|hagakure|souga-ha|finn|merle|rosaria|milly|guabi|nemea|bernetta|yone|niv|nave)(?:-dark)?)$/.test(value.theme) ? value.theme : 'light',
    parties,
  };
}
