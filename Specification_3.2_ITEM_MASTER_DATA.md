...
| 6 | E | `Procyonian` | `i.bolt`BD | 葉の迅撃ボルト |
| 6 | E | `Procyonian` | `i.archery`BD | 葉の狩弓 |
...
| 8 | E | `Cervin` | `i.sword`BD | 鹿神王の剣 |
| 8 | E | `Cervin` | `i.armor`BD | 鹿神王の鎧 |
| 8 | E | `Cervin` | `i.wand`BD | 鹿神王の杖 |
| 8 | E | `Cervin` | `i.bolt`BD | 鹿神王の閃ボルト |
