...
| 7 | E | `Origami` | `i.gauntlet`EC | 飛翼の手甲 |
| 7 | E | `Origami` | `i.grimoire`EC | 飛翼の秘本 |
| 7 | E | `Origami` | `i.robe`EC | 飛翼の羽衣 |
| 7 | E | `Origami` | `i.arrow`EC | 天翔の翼矢 |
| 7 | E | `Origami` | `i.bolt`EC | 風裂ボルト |
| 7 | E | `Origami` | `i.archery`EC | 翼騎の長弓 |
| 7 | E | `Pony` | `i.sword`EA | 巨人剣 |
| 7 | E | `Pony` | `i.shield`EA | 巨大盾 |
| 7 | E | `Pony` | `i.wand`EA | 巨神の導杖 |
| 7 | E | `Pony` | `i.grimoire`EA | ロゼッタストーン |
| 7 | E | `Pony` | `i.robe`EA | 巨神の法衣 |
| 7 | E | `Pony` | `i.bolt`EA | 巨神のボルト |
| 7 | E | `Pony` | `i.katana`EA | 巨太刀 |
