...
| 226 | 4 | 4 | 1-2 | 24 | Normal | `Murid` | class.guardian.wizard | `i.armor`U, `i.gauntlet`U, `i.wand`U, `i.armor`C, `i.robe`C, `i.shield`C | 砂猫のあらくれもの |
| 227 | 4 | 4 | 1-2 | 24 | Normal | `Murid` | class.lord.striker | `i.shield`U, `i.katana`U, `i.bolt`U, `i.armor`C, `i.robe`C, `i.shield`C | あらくれ兄貴猫 |
| 228 | 4 | 4 | 1-2 | 24 | Normal | `Murid` | class.sage.samurai | `i.grimoire`U, `i.catalyst`U, `i.katana`U, `i.wand`C, `i.grimoire`C, `i.catalyst`C | 夜砂のぐれ猫 |
...
| 231 | 4 | 4 | 4 | 27 | Elite | `Murid` | class.ninja.duelist | `i.archery`EB, `i.bolt`EB, `i.sword`EB, `i.arrow`C, `i.bolt`C, `i.archery`C | 忍猫ネロ |
...
| 236 | 4 | 5 | 3 | 26 | Normal | `Murid` | class.wizard.ninja | `i.wand`U, `i.robe`U, `i.archery`U, `i.wand`C, `i.grimoire`C, `i.catalyst`C | 流砂の術忍猫 |
...
| 238 | 4 | 6 | 1-2 | 26 | Normal | `Felidian` | class.duelist.striker | `i.sword`U, `i.armor`U, `i.bolt`U, `i.sword`C, `i.katana`C, `i.gauntlet`C | 豊穣の門番 |
| 239 | 4 | 6 | 1-2 | 26 | Normal | `Felidian` | class.pilgrim.sage | `i.robe`U, `i.grimoire`U, `i.grimoire`U, `i.armor`C, `i.robe`C, `i.shield`C | 豊穣の祈祷師 |
| 240 | 4 | 6 | 1-2 | 26 | Normal | `Felidian` | class.sword-saint.striker | `i.gauntlet`U, `i.sword`U, `i.bolt`U, `i.sword`C, `i.katana`C, `i.gauntlet`C | 豊穣の護衛 |
| 241 | 4 | 6 | 3 | 27 | Normal | `Murid` | class.ranger.duelist | `i.arrow`U, `i.archery`U, `i.sword`U, `i.arrow`C, `i.bolt`C, `i.archery`C | 豊穣の親衛射手 |
| 242 | 4 | 6 | 3 | 27 | Normal | `Murid` | class.samurai.ranger | `i.katana`U, `i.shield`U, `i.arrow`U, `i.sword`C, `i.katana`C, `i.gauntlet`C | 豊穣の親衛隊 |
