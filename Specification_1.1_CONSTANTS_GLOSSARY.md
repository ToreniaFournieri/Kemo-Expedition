...
| `a.arcane-stability` | 術式安定 | 魔法攻撃の命中率はNを下回らない | Lv1: 55%, Lv2: 60% |
| `a.heavy-strike` | 重撃 | 物理ダメージを1.4倍する。攻撃回数を半減し(切り上げ)、減少分を貫通値に変換する(N) | Lv1: +1%/回, Lv2: +1.5%/回 |
| `a.arc-magic` | 大魔法 | 使用する魔法が大魔法になる(魔法攻撃回数が1/3倍になり、魔法ダメージが3倍になる) | - |
...
| `a.ice-reflect` | 氷結反射 | 自身が受ける予定の通常攻撃の氷属性ダメージのNを反射して相手に与える(自身は残りを受ける) | Lv1: 反射1/10・被弾9/10, Lv2: 反射3/10・被弾7/10, Lv3: 反射5/10・被弾5/10, Lv4: 反射7/10・被弾3/10, Lv5: 反射100%・被弾0% | START | 4 |
| `a.fire-reflect` | 火炎反射 | 自身が受ける予定の通常攻撃の火属性ダメージのNを反射して相手に与える(自身は残りを受ける) | Lv1: 反射1/10・被弾9/10, Lv2: 反射3/10・被弾7/10, Lv3: 反射5/10・被弾5/10, Lv4: 反射7/10・被弾3/10, Lv5: 反射100%・被弾0% | START | 4 |
| `a.thunder-reflect` | 雷撃反射 | 自身が受ける予定の通常攻撃の雷属性ダメージのNを反射して相手に与える(自身は残りを受ける) | Lv1: 反射1/10・被弾9/10, Lv2: 反射3/10・被弾7/10, Lv3: 反射5/10・被弾5/10, Lv4: 反射7/10・被弾3/10, Lv5: 反射100%・被弾0% | START | 4 |
| `a.magical-reflect` | 魔法反射 | 自身が受ける予定の通常攻撃の魔法ダメージのNを反射して相手に与える(自身は残りを受ける) | Lv1: 反射1/10・被弾9/10, Lv2: 反射3/10・被弾7/10, Lv3: 反射5/10・被弾5/10, Lv4: 反射7/10・被弾3/10, Lv5: 反射100%・被弾0% | START | 4 |
| `a.ranged-reflect` | 矢返し | 自身が受ける予定の遠距離攻撃ダメージのNを反射して相手に与える(自身は残りを受ける) | Lv1: 反射1/10・被弾9/10, Lv2: 反射3/10・被弾7/10, Lv3: 反射5/10・被弾5/10, Lv4: 反射7/10・被弾3/10, Lv5: 反射100%・被弾0% | START | 4 |
| `a.melee-reflect` | 打ち返し | 自身が受ける予定の近接攻撃ダメージのNを反射して相手に与える(自身は残りを受ける) | Lv1: 反射1/10・被弾9/10, Lv2: 反射3/10・被弾7/10, Lv3: 反射5/10・被弾5/10, Lv4: 反射7/10・被弾3/10, Lv5: 反射100%・被弾0% | START | 4 |
...
| `f.` Key | 表示 | 説明 |
|--------|------|------|
| `f.physical-targeting` | 物理ターゲッティング | 遠距離フェーズ/近距離フェーズの攻撃対象選択する。\n隊列5に物理攻撃を3回以上狙われる可能性は、敵が32回攻撃では決して発生しない。\n| 隊列 | 可能性 |\n|---|----|\n| 1 | 16 |\n| 2 | 8 |\n| 3 | 4 |\n| 4 | 2 |\n| 5 | 1 |\n| 6 | 1 | |
| `f.magical-targeting` | 魔法ターゲッティング | 魔法フェーズは隊列に依存せずに対象を選択する。\n| 隊列 | 可能性 |\n|---|----|\n| 1 | 2 |\n| 2 | 2 |\n| 3 | 2 |\n| 4 | 2 |\n| 5 | 2 |\n| 6 | 2 | |
...
|--|--|---|---|---|---|---|---|---|
| 0 | (none) | |  | | | | | |
| 1 | `q.squander` | 散財(XXXG) | 宴会で XXXG 浪費する(0%, XXXG)　(神魔戦で中止) | 500 ~ 2,000 G | 16 hours | | 散財 | 宴会で浪費する(神魔戦で中止) (500 ~ 2,000G) |
| 2 | `q.sleeping` | 安眠(X時間) | X分寝る(0%, XX分)　(神魔戦で中止) | 20分 ~ 60分 | 16 hours | | 安眠 | 寝る(神魔戦で中止) (20分 ~ 60分) |
| 3 | `q.exercise` | 運動(XX分) | X分歩く(0%, XX分)　(神魔戦で中止) | 45分 ~ 150分 | 16 hours | count the time of 移動中 and 帰還中 state | 運動 | 歩く(神魔戦で中止) (45分 ~ 150分) |
| 4 | `q.embezzlement` | 横領(XXXG) | XXXG着服する(60%, XXXG)　(神魔戦で中止) | 100 ~ 400G | 16 hours | | 横領 | 着服する(神魔戦で中止) (100 ~ 400G) | 
| 5 | `q.donation` | 寄付(XXXG) | 1,500G寄付する(10%, XXXG)　(神魔戦で中止) | 400 ~ 2,000G | 12 hours | | 寄付 | 寄付する(神魔戦で中止) (400 ~ 2,000G)| 
| 6 | `q.healing` | 治療(X時間) | X時間治療を受ける (10%, XX分)　(神魔戦で中止) | 60分 ~ 120分 | 16 hours | count the time of rest state | 治療 | 治療を受ける(神魔戦で中止) (60分 ~ 120分) |
| 7 | `q.AFK` | 放置(X時間) | X時間神から見放されている (10%, XX分)　(神魔戦で中止) | 180分 ~ 360分 | 16 hours | | 放置 | 神から見放されている(神魔戦で中止) (180分 ~ 360分) |
| 8 | `q.treasure-super-rare` | 超レアX個獲得 | 超レアを X個獲得する(0%, X個)　(神魔戦で中止) | 1 ~ 2 | 24 hours | | 超レア獲得 | 超レアを獲得する(神魔戦で中止) (1個 ~ 2個) |
| 9 | `q.treasure-boss-rare` | ボスレアXX個獲得 | ボスレアを XX個獲得する(0%, X個)　(神魔戦で中止) | 5 ~ 15 | 16 hours | | ボスレア獲得 | ボスレアを獲得する(神魔戦で中止) (5個 ~ 15個) | 
| 10 | `q.poor-kid` | アイテム獲得空振り(XXX回) | XXX回アイテム獲得空振り(0%, X個)　(神魔戦で中止) | 500 ~ 1500 | 9 hours | | アイテム獲得空振り | アイテム獲得空振り(神魔戦で中止) (500回 ~ 1500回) |
...
| 12 | `q.losers` | 敗北(X回) | X回敗北する(0%, X回)　(神魔戦で中止) | 3 ~ 6 | 16 hours | |  敗北 | 敗北する(神魔戦で中止)　(3回~ 6回) |
| 13 | `q.savings` | 貯金(XXXG) | 3,000G貯金する(10%, XXXG)　(神魔戦で中止) | 800 ~ 4,000G | 16 hours | | 貯金 | 貯金する(神魔戦で中止) (800 ~ 4,000G)　|
...
| `terrain.chill` | 冷気 | 部屋の継続時間が1.5倍になる |
