...
| `a.resonance`4 | 共鳴4 | 魔法攻撃 1回毎に、全ヒットのダメージが +11% 増加する | preemptive |
| `a.resonance`5 | 共鳴5 | 魔法攻撃 1回毎に、全ヒットのダメージが +12% 増加する | preemptive |
| `a.stealth`1 | 隠れ蓑1 | HP24%未満の時、自身へのダメージをすべて回避する| preemptive |
| `a.stealth`2 | 隠れ蓑2 | HP29%未満の時、自身へのダメージをすべて回避する| preemptive |
| `a.illusion`1 | 幻化1 | 自分が受ける最初の遠距離攻撃を無効化する | preemptive |
| `a.illusion`2 | 幻化2 | パーティーが受ける最初の遠距離攻撃を無効化する | preemptive |
...
| `a.deflection`1 | 矢払い1 |　敵の遠距離攻撃の命中率を 10%低下 させる | START | 3 |
| `a.deflection`2 | 矢払い2 |　敵の遠距離攻撃の命中率を 15%低下 させる | START | 3 |
...
| `a.first-strike`1 | 先制攻撃1 | 行動が速くなる | 3 |
| `a.first-strike`2 | 先制攻撃2 | 行動がとても速くなる | 3 |
| `a.first-strike`3 | 先制攻撃3 | 行動が極めて速くなる | 3 |
| `a.slow`1 | 鈍足1 | 自身の行動順番に-1して遅くなる | 3 |
