...
const equippedItem = strict({ characterId: integerId, partyNumber, member: Type.Integer({ minimum: 1, maximum: 6 }), slotIndex: Type.Integer({ minimum: 0 }), item: itemFormat, jewel: Type.Union([Type.String({ pattern: '^(might|arcana|fort|ward|shade|focus):[1-8]$' }), Type.Null()]), active: Type.Boolean() });
