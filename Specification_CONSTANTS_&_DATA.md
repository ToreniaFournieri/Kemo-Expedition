...
| `a.ice-reflect`1 | 氷結反射1 | [効] 自身が受ける予定の通常攻撃の氷属性ダメージを反射(3/10)して相手に与える(自身はダメージを受けない) |
| `a.fire-reflect`1 | 火炎反射1 | [効] 自身が受ける予定の通常攻撃の火属性ダメージを反射(3/10)して相手に与える(自身はダメージを受けない) | 
| `a.magical-reflect`1 | 魔法反射1 | [効] 自身が受ける予定の通常攻撃の魔法ダメージを反射(1/10)して相手に与える(自身はダメージを受けない) |
