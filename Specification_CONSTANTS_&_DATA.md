...
| `a.momentum`1 | 気勢1 | 物理/魔法攻撃倍率1.25倍(受けたダメージ1%につき0.5%減) |
| `a.momentum`2 | 気勢2 | 物理/魔法攻撃倍率1.25倍(受けたダメージ1%につき0.4%減) |
...
| `f.super_rare_scaling`| 超レアの性能向上 | 超レア称号が付くと、さらにその基礎性能が2倍される。また、それぞれ独自のボーナスが付与される。\n| 超レアID | 可能性 |\n|------|-----|\n| (なし)  | 399,920 |\n| 1 | 1 |\n| 2 | 1 |\n| ... | 1 |\n| 80 | 1 |
 ...
 | `f.equipment_slots` | 装備枠増加 | レベルアップに応じて装備枠が増える。 table format `f.equipment_slots`@Specification.md |
...
| 6 | `q.healing` | 治療(X時間) | X時間治療を受ける (10%, XX分)　(神魔戦で中止) | 60分 ~ 120分 | count the time of 休息中 state | 治療 | 治療を受ける(神魔戦で中止) (60分 ~ 120分) |
...
| 10 | `q.poor_kid` | アイテム獲得空振り(XXX回) | XXX回アイテム獲得空振り(0%, X個)　(神魔戦で中止) | 100 ~ 300 | | アイテム獲得空振り | アイテム獲得空振り(神魔戦で中止) (100回 ~ 300回) |
