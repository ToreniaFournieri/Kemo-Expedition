...
| `a.ice-reflect`1 | 氷結反射1 | [効] 自身が受ける予定の氷属性ダメージを反射(3/10)して相手に与える(自身はダメージを受けない) |
| `a.fire-reflect`1 | 火炎反射1 | [効] 自身が受ける予定の火属性ダメージを反射(3/10)して相手に与える(自身はダメージを受けない) | 
| `a.magical-reflect`1 | 魔法反射1 | [効] 自身が受ける予定の魔法ダメージを反射(1/10)して相手に与える(自身はダメージを受けない) |
| `a.frostbite`1 | 凍傷1 | [効] 相手の行動順番に-1を加えて遅らせる |
| `a.mutual-magic-amplify`1 | 魔法増幅1 | [効] 双方魔法ダメージ1.3倍 |
| `a.mutual-magic-restraint`1 | 魔法抑制1 | [効] 双方魔法ダメージ0.8倍 |
| `a.mutual-physical-amplify`2 | 物理増幅2 | [効] 双方物理ダメージ1.4倍 |
| `a.mutual-physical-restraint`1 | 物理抑制1 | [効] 双方物理ダメージ0.8倍 |
| `a.oblivion`1 | 忘却1 | [効] 無作為に選んだ相手のアビリティ1つをこの戦闘中無効にする |
| `a.magic-seal`1 | 魔封1 | [効] 魔法フェーズの最初の魔法を無力化する(相手だけでなく自身や味方にもこの制約を受ける) |
| `a.mimic`1 | 模倣1 | [効] 相手のアビリティ1つを無作為に指定する。指定したアビリティの効果を発動する |
| `a.colossal`1 | 巨人1 | [効] 自身の防御力が2倍になるが、自身の物理ダメージ補正x2.0 |
| `a.upgrade-all-abilities`1 | 他のアビリティ強化+1 | [効] 自身の他のアビリティを１段階強化する |
