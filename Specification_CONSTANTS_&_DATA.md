...
| `a.` ability | 表示 | 説明 |
|----|----|----|
| `a.defender`1 | 守護者1 | 自身より後列の味方への物理ダメージを 2/3倍 |
| `a.defender`2 | 守護者2 | 自身より後列の味方への物理ダメージを 3/5倍  |
| `a.defender`3 | 守護者3 | 自身より後列の味方への物理ダメージを 1/2倍 |
...
| `a.command`1 | 指揮1 | 自身より後列の味方が与える物理ダメージを 1.2倍 |
| `a.command`2 | 指揮2 | 自身より後列の味方が与える物理ダメージを 1.35倍 |
| `a.command`3 | 指揮3 | 自身より後列の味方が与える物理ダメージを 1.43倍 |
...
| `a.m-barrier`1 | 魔法障壁1 | 自身より後列の味方への魔法ダメージを 2/3倍 |
| `a.m-barrier`2 | 魔法障壁2 | 自身より後列の味方への魔法ダメージを 3/5倍 |
| `a.m-barrier`3 | 魔法障壁2 | 自身より後列の味方への魔法ダメージを 1/2倍 |
...
| `a.rage`1 | 闘志1 | 物理/魔法攻撃倍率増大(受けたダメージ1%につき0.5%増) |
| `a.rage`2 | 闘志2 | 物理/魔法攻撃倍率増大(受けたダメージ1%につき0.6%増) |
| `a.re-counter`1 | 再反撃1 | 敵から反撃に対して、反撃する(攻撃回数半減) |
| `a.re-counter`2 | 再反撃2 | 敵から反撃に対して、反撃する(攻撃回数半減しない) |
| `a.momentum`1 | 気勢1 | 物理/魔法攻撃倍率1.25倍(受けたダメージ1%につき0.5%減)、収益の一部を着服する |
| `a.momentum`2 | 気勢2 | 物理/魔法攻撃倍率1.25倍(受けたダメージ1%につき0.4%減)、収益の一部を着服する |
...
| `a.ice-reflect`1 | 氷結反射1 | [効] 自身が受ける予定の通常攻撃の氷属性ダメージを反射(1/10)して相手に与える(自身もダメージ(9/10)を受ける |
| `a.ice-reflect`2 | 氷結反射2 | [効] 自身が受ける予定の通常攻撃の氷属性ダメージを反射(3/10)して相手に与える(自身もダメージ(7/10)を受ける |
| `a.ice-reflect`3 | 氷結反射3 | [効] 自身が受ける予定の通常攻撃の氷属性ダメージを反射(5/10)して相手に与える(自身もダメージ(5/10)を受ける) |
| `a.ice-reflect`4 | 氷結反射4 | [効] 自身が受ける予定の通常攻撃の氷属性ダメージを反射(7/10)して相手に与える(自身もダメージ(3/10)を受ける) |
| `a.ice-reflect`5 | 氷結反射5 | [効] 自身が受ける予定の通常攻撃の氷属性ダメージを全反射して相手に与える(自身はダメージを受けない) |
| `a.fire-reflect`1 | 火炎反射1 | [効] 自身が受ける予定の通常攻撃の火属性ダメージを反射(1/10)して相手に与える(自身もダメージ(9/10)を受ける |
| `a.fire-reflect`2 | 火炎反射2 | [効] 自身が受ける予定の通常攻撃の火属性ダメージを反射(3/10)して相手に与える(自身もダメージ(7/10)を受ける |
| `a.fire-reflect`3 | 火炎反射3 | [効] 自身が受ける予定の通常攻撃の火属性ダメージを反射(5/10)して相手に与える(自身もダメージ(5/10)を受ける) |
| `a.fire-reflect`4 | 火炎反射4 | [効] 自身が受ける予定の通常攻撃の火属性ダメージを反射(7/10)して相手に与える(自身もダメージ(3/10)を受ける) |
| `a.fire-reflect`5 | 火炎反射5 | [効] 自身が受ける予定の通常攻撃の火属性ダメージを全反射して相手に与える(自身はダメージを受けない) |
| `a.thunder-reflect`1 | 雷撃反射1 | [効] 自身が受ける予定の通常攻撃の雷属性ダメージを反射(1/10)して相手に与える(自身もダメージ(9/10)を受ける |
| `a.thunder-reflect`2 | 雷撃反射2 | [効] 自身が受ける予定の通常攻撃の雷属性ダメージを反射(3/10)して相手に与える(自身もダメージ(7/10)を受ける |
| `a.thunder-reflect`3 | 雷撃反射3 | [効] 自身が受ける予定の通常攻撃の雷属性ダメージを反射(5/10)して相手に与える(自身もダメージ(5/10)を受ける) |
| `a.thunder-reflect`4 | 雷撃反射4 | [効] 自身が受ける予定の通常攻撃の雷属性ダメージを反射(7/10)して相手に与える(自身もダメージ(3/10)を受ける) |
| `a.thunder-reflect`5 | 雷撃反射5 | [効] 自身が受ける予定の通常攻撃の雷属性ダメージを全反射して相手に与える(自身はダメージを受けない) |
| `a.magical-reflect`1 | 魔法反射1 | [効] 自身が受ける予定の通常攻撃の魔法ダメージを反射(1/10)して相手に与える(自身もダメージ(9/10)を受ける |
| `a.magical-reflect`2 | 魔法反射2 | [効] 自身が受ける予定の通常攻撃の魔法ダメージを反射(3/10)して相手に与える(自身もダメージ(7/10)を受ける |
| `a.magical-reflect`3 | 魔法反射3 | [効] 自身が受ける予定の通常攻撃の魔法ダメージを反射(5/10)して相手に与える(自身もダメージ(5/10)を受ける) |
| `a.magical-reflect`4 | 魔法反射4 | [効] 自身が受ける予定の通常攻撃の魔法ダメージを反射(7/10)して相手に与える(自身もダメージ(3/10)を受ける) |
| `a.magical-reflect`5 | 魔法反射5 | [効] 自身が受ける予定の通常攻撃の魔法ダメージを全反射して相手に与える(自身はダメージを受けない) |
| `a.ranged-reflect`1 | 矢返し1 | [効] 自身が受ける予定の遠距離攻撃のダメージを反射(1/10)して相手に与える(自身もダメージ(9/10)を受ける |
| `a.ranged-reflect`2 | 矢返し2 | [効] 自身が受ける予定の遠距離攻撃のダメージを反射(3/10)して相手に与える(自身もダメージ(7/10)を受ける |
| `a.ranged-reflect`3 | 矢返し3 | [効] 自身が受ける予定の遠距離攻撃のダメージを反射(5/10)して相手に与える(自身もダメージ(5/10)を受ける) |
| `a.ranged-reflect`4 | 矢返し4 | [効] 自身が受ける予定の遠距離攻撃のダメージを反射(7/10)して相手に与える(自身もダメージ(3/10)を受ける) |
| `a.ranged-reflect`5 | 矢返し5 | [効] 自身が受ける予定の遠距離攻撃のダメージを全反射して相手に与える(自身はダメージを受けない) |
| `a.melee-reflect`1 | 打ち返し1 | [効] 自身が受ける予定の遠距離攻撃のダメージを反射(1/10)して相手に与える(自身もダメージ(9/10)を受ける |
| `a.melee-reflect`2 | 打ち返し2 | [効] 自身が受ける予定の近接攻撃のダメージを反射(3/10)して相手に与える(自身もダメージ(7/10)を受ける |
| `a.melee-reflect`3 | 打ち返し3 | [効] 自身が受ける予定の近接攻撃のダメージを反射(5/10)して相手に与える(自身もダメージ(5/10)を受ける) |
| `a.melee-reflect`4 | 打ち返し4 | [効] 自身が受ける予定の近接攻撃のダメージを反射(7/10)して相手に与える(自身もダメージ(3/10)を受ける) |
| `a.melee-reflect`5 | 打ち返し5 | [効] 自身が受ける予定の近接攻撃のダメージを全反射して相手に与える(自身はダメージを受けない) |
| `a.ice-null`1 | 氷結無効1 | [効] 自身が受ける予定の通常攻撃の氷属性ダメージを無効化する |
| `a.fire-null`1 | 火炎無効1 | [効] 自身が受ける予定の通常攻撃の火属性ダメージを無効化する |
| `a.thunder-null`1 | 雷撃無効1 | [効] 自身が受ける予定の通常攻撃の雷属性ダメージを無効化する |
| `a.magical-null`1 | 魔法無効1 | [効] 自身が受ける予定の通常攻撃の魔法ダメージを無効化する |
| `a.ranged-null`1 | 遠距離無効1 | [効] 自身が受ける予定の遠距離攻撃のダメージを無効化する |
| `a.melee-null`1 | 近接無効1 | [効] 自身が受ける予定の近接攻撃のダメージを無効化する |
| `a.ice-absorb`1 | 氷結吸収1 | [効] 自身が受ける予定の通常攻撃の氷属性ダメージを無効化し、一部吸収(1/10)して回復する |
| `a.ice-absorb`2 | 氷結吸収2 | [効] 自身が受ける予定の通常攻撃の氷属性ダメージを無効化し、一部吸収(3/10)して回復する |
| `a.ice-absorb`3 | 氷結吸収3 | [効] 自身が受ける予定の通常攻撃の氷属性ダメージを無効化し、一部吸収(5/10)して回復する |
| `a.ice-absorb`4 | 氷結吸収4 | [効] 自身が受ける予定の通常攻撃の氷属性ダメージを無効化し、一部吸収(7/10)して回復する |
| `a.ice-absorb`5 | 氷結吸収5 | [効] 自身が受ける予定の通常攻撃の氷属性ダメージを無効化し、全て吸収して回復する |
| `a.fire-absorb`1 | 火炎吸収1 | [効] 自身が受ける予定の通常攻撃の火属性ダメージを無効化し、一部吸収(1/10)して回復する |
| `a.fire-absorb`2 | 火炎吸収2 | [効] 自身が受ける予定の通常攻撃の火属性ダメージを無効化し、一部吸収(3/10)して回復する |
| `a.fire-absorb`3 | 火炎吸収3 | [効] 自身が受ける予定の通常攻撃の火属性ダメージを無効化し、一部吸収(5/10)して回復する |
| `a.fire-absorb`4 | 火炎吸収4 | [効] 自身が受ける予定の通常攻撃の火属性ダメージを無効化し、一部吸収(7/10)して回復する |
| `a.fire-absorb`5 | 火炎吸収5 | [効] 自身が受ける予定の通常攻撃の火属性ダメージを無効化し、全て吸収して回復する |
| `a.thunder-absorb`1 | 雷撃吸収1 | [効] 自身が受ける予定の通常攻撃の雷属性ダメージを無効化し、一部吸収(1/10)して回復する |
| `a.thunder-absorb`2 | 雷撃吸収2 | [効] 自身が受ける予定の通常攻撃の雷属性ダメージを無効化し、一部吸収(3/10)して回復する |
| `a.thunder-absorb`3 | 雷撃吸収3 | [効] 自身が受ける予定の通常攻撃の雷属性ダメージを無効化し、一部吸収(5/10)して回復する |
| `a.thunder-absorb`4 | 雷撃吸収4 | [効] 自身が受ける予定の通常攻撃の雷属性ダメージを無効化し、一部吸収(7/10)して回復する |
| `a.thunder-absorb`5 | 雷撃吸収5 | [効] 自身が受ける予定の通常攻撃の雷属性ダメージを無効化し、全て吸収して回復する |
| `a.magical-absorb`1 | 魔法吸収1 | [効] 自身が受ける予定の通常攻撃の魔法ダメージを無効化し、一部吸収(1/10)して回復する |
| `a.magical-absorb`2 | 魔法吸収2 | [効] 自身が受ける予定の通常攻撃の魔法ダメージを無効化し、一部吸収(3/10)して回復する |
| `a.magical-absorb`3 | 魔法吸収3 | [効] 自身が受ける予定の通常攻撃の魔法ダメージを無効化し、一部吸収(5/10)して回復する |
| `a.magical-absorb`4 | 魔法吸収4 | [効] 自身が受ける予定の通常攻撃の魔法ダメージを無効化し、一部吸収(7/10)して回復する |
| `a.magical-absorb`5 | 魔法吸収5 | [効] 自身が受ける予定の通常攻撃の魔法ダメージを無効化し、全て吸収して回復する |
| `a.frostbite`1 | 凍傷1 | [効] 相手の行動順番に-1を加えて遅らせる |
| `a.mutual-magic-amplify`1 | 魔法増幅1 | [効] 双方魔法ダメージ1.3倍 |
| `a.mutual-magic-amplify`2 | 魔法増幅2 | [効] 双方魔法ダメージ1.5倍 |
| `a.mutual-magic-amplify`3 | 魔法増幅3 | [効] 双方魔法ダメージ1.6倍 |
| `a.mutual-magic-amplify`4 | 魔法増幅4 | [効] 双方魔法ダメージ1.65倍 |
| `a.mutual-magic-amplify`5 | 魔法増幅5 | [効] 双方魔法ダメージ1.68倍 |
| `a.mutual-magic-restraint`1 | 魔法抑制1 | [効] 双方魔法ダメージ0.77倍 |
| `a.mutual-magic-restraint`2 | 魔法抑制2 | [効] 双方魔法ダメージ0.67倍 |
| `a.mutual-magic-restraint`3 | 魔法抑制3 | [効] 双方魔法ダメージ0.63倍 |
| `a.mutual-magic-restraint`4 | 魔法抑制4 | [効] 双方魔法ダメージ0.61倍 |
| `a.mutual-magic-restraint`5 | 魔法抑制5 | [効] 双方魔法ダメージ0.59倍 |
| `a.mutual-physical-amplify`1 | 物理増幅1 | [効] 双方物理ダメージ1.3倍 |
| `a.mutual-physical-amplify`2 | 物理増幅2 | [効] 双方物理ダメージ1.5倍 |
| `a.mutual-physical-amplify`3 | 物理増幅3 | [効] 双方物理ダメージ1.6倍 |
| `a.mutual-physical-amplify`4 | 物理増幅4 | [効] 双方物理ダメージ1.65倍 |
| `a.mutual-physical-amplify`5 | 物理増幅5 | [効] 双方物理ダメージ1.68倍 |
| `a.mutual-physical-restraint`1 | 物理抑制1 | [効] 双方物理ダメージ0.77倍 |
| `a.mutual-physical-restraint`2 | 物理抑制2 | [効] 双方物理ダメージ0.67倍 |
| `a.mutual-physical-restraint`3 | 物理抑制3 | [効] 双方物理ダメージ0.63倍 |
| `a.mutual-physical-restraint`4 | 物理抑制4 | [効] 双方物理ダメージ0.61倍 |
| `a.mutual-physical-restraint`5 | 物理抑制5 | [効] 双方物理ダメージ0.59倍 |
| `a.oblivion`1 | 忘却1 | [効] 無作為に選んだ相手のアビリティ1つを、この戦闘中無効化する |
| `a.magic-seal`1 | 魔封1 | [効] 魔法フェーズの最初の魔法を無力化する(相手だけでなく自身や味方にもこの制約を受ける) |
| `a.mimic`1 | 模倣1 | [効] 相手のアビリティ1つを無作為に指定する。指定したアビリティの効果を発動する |
| `a.howl`1 | 遠吠え1 | 遠距離2タイミングで発動。相手の次の攻撃回数4/5 |
| `a.ranged-confusion`1 | 遠距離混乱1 | 遠距離2タイミングで発動。1/8の確率で無作為に選んだ相手を敵対状態とする。遠距離0(終了)タイミングで敵対状態は解消する |
| `a.unstable-core`1 | 不安定1 | 遠距離0(終了)タイミングと魔法0(終了)タイミングにそれぞれ発動。残HP30%の自傷ダメージを受ける |
| `a.soul-reap`1 | 魂奪1 | 魔法0(終了)タイミングで発動。相手のHPが10％未満であった場合、相手は即死する。回避も復活もできない |
| `a.regeneration`3 | 再生3 | 近接9(開始)タイミングで発動。この戦闘で失ったHPの20%を回復する。近接フェーズ前までにHPが0となった場合には発動しない |
| `a.predator-sense`1 | 捕食1 | 近接9(開始)タイミングで発動。相手のHPが50％未満の場合、命中+30 |
| `a.decompose`1 | 分解1 | 近接2タイミングで発動。相手の物理防御力を2/3 |
| `a.self-destruct`1 | 自爆1 | 近接2タイミングで発動。自爆する。相手に残ダメージの3/10を与える |
| `a.free`1 | 逃走1 | 近接1タイミングで発動。戦闘から逃げる(戦闘は引分になる) |
| `a.auriferous`1 | 含金1 | [末] 自身が受ける総攻撃回数10回毎に、自身がドロップするアイテム抽選確率を+1する |
| `a.slow`1 | 鈍足1 | 自身の行動順番に-1して遅くなる |
| `a.no-offense`1 | 受身1 | 通常行動をしなくなる(反撃などは行う) |
| `a.swarm`1 | 群れ1 | 自身のHPが減ると攻撃倍率・防御倍率減(HP1%につき0.5%減少) |
| `a.reanimate`3 | 即時蘇生3 | 自身のHPが0となったタイミングで発動。HP30%で復活する(戦闘中1回のみ有効) |
| `a.ambush`1 | 待ち伏せ1 | 自身の通常行動時点でいずれの相手もまだこの戦闘中に行動していなかった場合、与ダメージ1.3倍 |
| `a.shock`1 | 感電1 | 相手の最初の近接攻撃に対して発動。相手の近接攻撃が1回目ヒットした段階で攻撃をやめさせる |
| `a.corrode`1 | 腐食1 | 近接攻撃が1回以上命中した相手に対して、攻撃倍率x2/3 |
| `a.life-drain`3 | 吸血1 | 近接攻撃で相手に与えたダメージの3/10を回復 |
| `a.death-touch`1 | 接死1 | 近接攻撃の命中回数 x 1/128の確率で即死 |
| `a.burn`1 | 火傷1 | 相手の近接攻撃の命中した回数 x 1%のダメージを相手に与える |
| `a.bind`1 | 拘束1 | 近接攻撃の命中回数 x 1/32の確率で相手の行動を封じる |
| `a.flying`1 | 飛行1 | 相手の近接攻撃回数が1/4になる |
