...
- Strength of enemy by its level 
  ...
  - `x.exp_atk_mult`(n) = 1.4 * {(1.09 - max(0, 0.00049*(n-25)) - max(0, 0.00007*(n-49)))^n }
  - `x.exp_atk_amp_mult`(n) = 1 + {(1.03 - max(0, 0.000151*(n-25)) - max(0, 0.000052*(n-49)))^n - 1} / 2
  - `x.exp_NoA_mult`(n) =
...
| `x.exp_id` | `x.enemy_level` | `Enemy_ID` | Name |
|---:|---:|---:|---|
| 1 | 18 | 1 | Seiran |
| 2 | 25 | 2 | Garv |
| 3 | 32 | 3 | Kyōen |
...
| Aerial | 飛行 | 飛 | `a.flying`1, `a.vine-cutter`1 | `a.flee`1 | `c.evasion+0.045`, `c.growth_x0.7`  |
