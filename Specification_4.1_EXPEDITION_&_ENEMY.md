...
| `x.exp_id` | `x.enemy_level` | Name | Title | Display name | Class | Represent for | + ability | Drop item tier | Drop item category | Image file |
|-|-|-|-|-|-|-|-|-|-|-|
| 1 | 18 | Seiran | Goddess of Restoration | セイラン 再生の女神 | Pilgrim | Caninian | `a.resurrect`2  | 3 | `i.grimoire`, `i.robe`| /public/enemy/Gods_Seiran.png |
| 2 | 25 | Garv | God of Attrition | ガーヴ 消耗の神 | Samurai | Lupinian | `a.rage`2, `a.re-counter`2 | 4 | `i.katana`, `i.shield` | /public/enemy/Gods_Garv.png |
| 3 | 32 | Kyōen | God of Cunning | キョウエン 狡猾の神 | class.striker | Vulpinian | `a.momentum`2 | 5 |  `i.archery`, `i.bolt` | /public/enemy/Gods_Kyoen.png |
| 4 | 39 | Miora | Goddess of Fertility | ミオラ 豊穣の女神  | Sage | Felidian | `a.firststrike`2 | 7 | `i.sword`, `i.catalyst` | /public/enemy/Gods_Miora.png |
| 5 | 46 | Dolvar | God of Fortification | ドルヴァ 防備の神 | class.guardian | Ursan | `a.cyborgization`2 | 6 | `i.armor`, `i.gauntlet` | /public/enemy/Gods_Dolvar.png |
| 6 | 53 | Tanue | Goddess of Mirage | タヌエ 幻影の女神  | Duelist | Procyonian |  | 7 |  `i.sword`, `i.gauntlet` | /public/enemy/Gods_Tanue.png |
| 7 | 60 | Lira | Goddess of Precision | リラ 精密の女神 | Ranger | Leporian | `a.composure`2 | 8 | `i.arrow`, `i.archery` | /public/enemy/Gods_Lira.png |
| 8 | 61 | Forne | God of Fate | フォルネ 運命の神 | Lord | Cervin | `a.focus`2 | 8 | `i.armor`, `i.robe` | /public/enemy/Gods_Forne.png |
| 9 | 62 | Skuva | God of Dusk | スクヴァ 黄昏の神 | Ninja | Murid | `a.stealth`1 | 8 | `i.sheild`,`i.catalyst` | /public/enemy/Gods_Skuva.png |
| 10 | 63 | Rondel | God of Resonance | ロンデル 共鳴の神 | Wizard | Mustelid | `a.resonance`4 | 7 | `i.wand`, `i.arrow` | /public/enemy/Gods_Rondel.png |
| 11 | 70 | Noctyra | God of Oblivion | ノクティラ 忘却されし神 | Samurai | - | `a.rage`2, `a.firststrike`2 | 8 | `i.bolt`, `i.katana` | /public/enemy/Gods_Noctyra.png |
| 12 | 71 | Eris | Goddess of discord | エリス 不和の神 | Pilgrim | - | `a.momentum`2, `a.resonance`4, `a.stealth`1 | 8 | `i.grimoire`, `i.wand` | /public/enemy/Gods_Eris.png |
...
| class.samurai     | x0.92 | `a.iaigiri`1          | 0.00 | -0.02 | x0.9 | x0.8 | 0 | x0.9 | x0.8 | 0 | x2.0 | x1.0 | 1 | x1.0 | x0.7 | x0.8 |
| class.sword-saint | x1.18 | `a.re-attack`1        | 0.00 | 0.00 | x0.9 | x0.8 | 0 | x0.9 | x0.8 | 0 | x0.8 | x1.3 | 6 | x1.0 | x0.75 | x1.0 |
...
| class.ninja       | x0.87 | `a.first-strike`1     | 0.05 | 0.03 | x0.8 | x1.3 | 5 | x0.9 | x0.8 | 0 | x0.9 | x0.8 | 0 | x0.82 | x0.93 | x1.0 |
| class.wizard      | x0.72 | `a.resonance`1        | 0.00 |-0.015| x0.9 | x0.8 | 0 | x1.2 | x1.0 | 2 | x0.9 | x0.8 | 0 | x0.63 | x1.1 | x0.8 |
| class.sage        | x0.94 | `a.arc-magic`1        | 0.00 | 0.00 | x0.9 | x0.8 | 0 | x0.8 | x1.3 | 4 | x0.9 | x0.8 | 0 | x0.8 | x1.3 | x1.0 |
| class.alchemist   | x0.83 | `a.arcane-stability`1 | 0.00 | 0.00 | x0.9 | x0.8 | 0 | x1.2 | x1.0 | 5 | x0.9 | x0.8 | 0 | x0.7 | x1.0 | x1.2 |
| class.guardian    | x1.40 | (none)                | 0.00 | 0.00 | x0.9 | x0.8 | 0 | x0.8 | x0.8 | 0 | x0.9 | x0.8 | 2 | x1.2 | x0.6 | x1.0 |
| class.pilgrim     | x1.22 | (none)                | 0.00 | 0.00 | x0.9 | x0.8 | 0 | x0.9 | x0.85 | 2 | x0.9 | x0.9 | 0 | x1.1 | x1.1 | x0.4 |
| class.lord        | x1.18 | (none)                | 0.00 | 0.00 | x0.9 | x0.8 | 0 | x0.9 | x0.8 | 0 | x1.0 | x0.9 | 2 | x1.2 | x1.0 | x1.6 |
