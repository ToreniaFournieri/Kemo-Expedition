...
| 売却中 | at home, Sell auto-sell items to shop owners. and officially gain items (notification of item gains at the end of 売却中 state.). If they have no trophy nor auto-sell item, skip this state. | 5 seconds | 宴会中 |
...
| 移動中 | home → dungeon, duration 5 sec. If party.character.`a.peddler`, reduce its duration. (`a.peddler`1: 2/3, `a.peddler`2: 3/5) | 5 seconds | 探索中 |
