...
| `a.re-attack1` | 連撃1 | 攻撃時に **追加攻撃を1回**行う(攻撃回数は半減) |
| `a.re-attack2` | 連撃2 | 攻撃時に **追加攻撃を2回**行う(攻撃回数は半減) |
| `a.iaigiri1` | 居合斬り1 | 物理ダメージをx2.0倍する。攻撃回数が半減する |
| `a.iaigiri2` | 居合斬り2 | 物理ダメージをx2.5倍する。攻撃回数を半減する |
...
| `a.resonance4` | 共鳴4 | 魔法攻撃 1回毎に、全ヒットのダメージが **+13%** 増加する |
| `a.resonance53` | 共鳴5 | 魔法攻撃 1回毎に、全ヒットのダメージが **+15%** 増加する |
