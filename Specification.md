...
| ムステリドの巣穴(Mustelid Burrow) | 巣 | x1,024 | x243 | x6 | x6 | x243 | x0.33 | 6 | The Copper Labyrinth. A massive subterranean industrial hive. The air is thick with chemical steam and the clank of gears. Only those with high-tier Catalysts can neutralize the toxins found in the deepest vents. |
...
| セルビンの谷(Cervin Vale) | 谷 | x16,384 | x2,187 | x8 | x8 | x729 | x0.21 | 8 | The Glass Horizon. A dimension where space and time have crystallized. The Cervin Sages reside here in total silence. Here, the final Grimoire and Katana await the one who can transcend mortality. |
...
- Expedition category tabs: 原, 崖, 河, 峰, 茂, 巣, 園, 谷
...
ID: 5005                   クラス: 戦士
HP: 312                    経験値: 88
遠攻: 0 x 0回(x1.00)      属性: 雷 (x1.2)
魔攻: 117 x 4回(x1.00)    魔防: 8 (80%)
近攻: 35 x 6回(x1.00)     物防: 10 (100%)
