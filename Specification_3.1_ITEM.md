...
|`i.katana` | x1.43 `d.melee_attack+D` | `c.melee_attack+F`, `d.evasion-J`, `d.melee_NoA-K` | x1.0 `d.HP+D` | x0.3 `d.magical_defense+D` | `r.fire-M`,`r.ice-M`, `r.thunder-M` | `c.penet+P` | `b.mind+1` |
...
|`i.archery` | x1.0 `d.ranged_NoA+E` | `c.ranged_NoA+H` | x1.0 `d.HP+D` | `r.fire-M`,`r.ice-M`, `r.thunder-M` | none | `c.accuracy+N` | `b.strength+1` |
|`i.wand` | x0.75 `d.magical_attack+D` | `c.magical_attack+F` | x0.3 `d.magical_defense+D` | x1.1 `d.HP+D` | `r.fire-M`,`r.ice-M`, `r.thunder-M` | none | `b.intelligence+1` |
...
氷紋の防寒衣 [2U] 物防+35 HP+41 精神+1 [物防+11%, 氷防x0.92]
```
