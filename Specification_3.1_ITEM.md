...
|----|-----|-----|------|-------|----|--------|-------|----|-------|------|------|-------|
| 1  | 12  | 0.8 | 0.13 | 0.013 | 1  | -0.001 | -1.0 | +0.15 | -10| 0.001 | 0.01 | 0.23 |
| 2  | 18  | 0.7 | 0.12 | 0.012 | 2  | -0.002 | -1.2 | +0.14 | -9 | 0.002 | 0.02 | 0.22 |
| 3  | 26  | 0.6 | 0.11 | 0.011 | 3  | -0.003 | -1.4 | +0.13 | -8 | 0.003 | 0.03 | 0.21 |
| 4  | 35  | 0.5 | 0.09 | 0.009 | 4  | -0.004 | -1.6 | +0.12 | -7 | 0.004 | 0.04 | 0.20 |
| 5  | 45  | 0.4 | 0.08 | 0.008 | 5  | -0.005 | -1.8 | +0.11 | -6 | 0.005 | 0.05 | 0.19 |
| 6  | 60  | 0.4 | 0.07 | 0.007 | 6  | -0.006 | -2.0 | +0.10 | -5 | 0.006 | 0.06 | 0.18 |
| 7  | 80  | 0.3 | 0.06 | 0.006 | 7  | -0.007 | -2.2 | +0.09 | -4 | 0.007 | 0.07 | 0.17 |
| 8  | 100 | 0.3 | 0.05 | 0.005 | 8  | -0.008 | -2.4 | +0.08 | -3 | 0.008 | 0.08 | 0.16 |
| 9  | 130 | 0.2 | 0.04 | 0.004 | 9  | -0.009 | -2.6 | +0.07 | -2 | 0.009 | 0.09 | 0.15 |
| 10 | 160 | 0.2 | 0.03 | 0.003 | 10 | -0.010 | -2.8 | +0.06 | -1 | 0.011 | 0.11 | 0.14 |
...
- Selling price and Purchesing price in Felis's Junk shop calculation 
  ...
  - Purchesing_price = (4 + 6 x `item_tier` ) x `rarity` x 10
