...
白銀英雄の鎧 [2B] 物防+85 魔防+25 HP+48 体力+1 [物防+8%] [鎧] ▼
 堅牢: 1 2 3 4 **5** 6 7 8  :[物防+8%] 物防+16 HP+16
 障壁: 1 2 3 4 5 6 7 8 
 影走: 1 2 3 4 5 6 7 8
名工の霧林司祭の法衣 [3E] 魔防+74 [魔防+8%] HP+47 回避+3 [法衣]　▲
伝説の幻導の青銅杖 [3U] 魔攻+67 [魔攻撃+9%] 魔防+25 [魔防+9%] [ワンド]　▲
...
- list and its descrpition is here:
  ...
  - 2.1.1 a. bonus ability, 2.1.2 b. bonus, 2.1.3 c. bonus, 2.1.4 d. bonus, 2.1.5, 2.1.6, 2.1.7, 2.1.8
- Glossary tabs: A, B, C, D, E, F, G, M. Default: A
