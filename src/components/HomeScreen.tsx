...
const PT_POTENTIAL_DEFAULT_NAMES: Record<number, Partial<Record<RaceId, string[]>>> = {
  1: {
    caninian: ['バヤル', 'ムンフ', 'ガンバト', 'テムージン', 'エルベグ', 'トゥムル'],
    cervin: ['アリウン', 'ソヨル', 'ウルジー', 'エルデン', 'ミシェール', 'バヤスガラン'],
    felidian: ['サラン', 'ナラン', 'オユナ', 'アルタン', 'エネレル', 'マラル'],
    leporian: ['ボルマ', 'セツェグ', 'トゥヤ', 'ノミン', 'デルゲル', 'アヌ'],
    lupinian: ['バトル', 'テムル', 'ガルダ', 'ソロンゴ', 'エルデネ', 'ジャルガル'],
    murid: ['タミル', 'ムンゲン', 'ジョルー', 'アマル', 'スフ', 'バトエル'],
    procyonian: ['チメド', 'ガントルガ', 'バザル', 'ツェレン', 'エンク', 'ロブサン'],
    ursan: ['ボルドー', 'ジャムツ', 'バトバヤル', 'サンジャ', 'オチル', 'ダシ'],
    vulpinian: ['アルスラン', 'ノヤン', 'チンギス', 'ボルド', 'サイン', 'トルガ'],
  },
  2: {
  ...
  5: {
    caninian: ['アルノー', 'ティボー', 'ギヨーム', 'フロラン', 'アドリアン', 'ベルナール'],
    cervin: ['エレーヌ', 'ヴィヴィアン', 'アデル', 'ロザリー', 'イザベル', 'シルヴィ'],
    felidian: ['セリーヌ', 'クレール', 'エロイーズ', 'マルゴ', 'ジュリエット', 'コレット'],
    leporian: ['アメリ', 'ノエミ', 'リゼット', 'カミーユ', 'エヴァ', 'マノン'],
    lupinian: ['ルシアン', 'ガスパール', 'テオ', 'マチュー', 'レミ', 'バスティアン'],
    murid: ['ピエール', 'ジャン', 'ルネ', 'ミシェル', 'アラン', 'フェリクス'],
    procyonian: ['パスカル', 'ノエ', 'ロマン', 'バジル', 'クロード', 'シモン'],
    ursan: ['レオン', 'ガブリエル', 'ユーグ', 'オーギュスト', 'マルセル', 'ドミニク'],
    vulpinian: ['ルナール', 'ジュリアン', 'エティエンヌ', 'シリル', 'ローラン', 'オリヴィエ'],
  },
  6: {
...
function PartyTab({
  ...
  // SpecRef: 2.2.1 | Potential default name for player side characters | PT-wide naming pool selection
  const getRandomDefaultNameForRace = (raceId: RaceId): string => {
    const partySlot = selectedPartyIndex + 1;
    const candidates = PT_POTENTIAL_DEFAULT_NAMES[partySlot]?.[raceId] ?? [];
