                    ...
                    return (
                      <button
                        ...
                        className={`min-w-0 flex flex-1 items-center justify-center px-0 py-1 text-xs border ${
                          isSelectedRace
                            ? 'bg-sub text-white border-sub'
                            : `border-gray-200 ${isDisabled ? 'bg-transparent text-gray-400' : 'bg-white/10 text-gray-600 hover:bg-white/25'}`
                                ...
                                return (
                                  <button
                                    ...
                                    className={`min-w-0 flex-1 px-0 py-1 text-xs border ${
                                      ...
                                      isSelected
                                        ? 'bg-sub text-white border-sub'
                                        : 'bg-white/10 text-gray-600 border-gray-200 hover:bg-white/25'
                                    }`}
                                  >
                                ...
                                return (
                                  <button
                                    ...
                                    className={`min-w-0 flex-1 px-0 py-1 text-xs border ${
                                      ...
                                      isSelected
                                        ? 'bg-sub text-white border-sub'
                                        : `border-gray-200 ${char.isUnique ? 'bg-transparent text-gray-400' : 'bg-white/10 text-gray-600 hover:bg-white/25'}`
                                    }`}
                                  >
                                ...
                                return (
                                  <button
                                    ...
                                    className={`min-w-0 flex-1 px-0 py-1 text-xs border ${
                                      ...
                                      isSelected
                                        ? 'bg-sub text-white border-sub'
                                        : `border-gray-200 ${char.isUnique || !isSelectable ? 'bg-transparent text-gray-400' : 'bg-white/10 text-gray-600 hover:bg-white/25'}`
                                    }`}
                                  >
