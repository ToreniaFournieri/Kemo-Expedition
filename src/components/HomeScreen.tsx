      ...
      {[0, 1, 2, 3, 4, 5].map((partyIndex) => {
        ...
        return (
          <div key={partyIndex} className="bg-pane relative rounded-lg p-2 overflow-hidden" style={expeditionPaneBackgroundStyle}>
            ...
            <div className={`relative z-10 rounded-md p-2 text-gray-900 ${isDarkModeEnabled ? 'bg-transparent' : 'bg-white/74'}`}>
            <button
              onClick={() => {
            ...
            >
              <span className="min-w-0 flex items-center gap-1.5">
                ...
                <span className="h-2 w-14 rounded-full bg-blue-100/55 overflow-hidden shrink-0">
            ...
            <div className="mb-1 relative h-9 min-w-0 rounded-md bg-white/45 overflow-hidden text-[11px]">
              <div
