            ...
            return <div key={`clairvoyance-${party.id}`} className="rounded border border-gray-200 bg-white p-2">
              ...
              {isExpanded && <div className="mt-2 space-y-1 text-sm">
                ...
                <div>
                  ...
                  <div className="pl-3 text-xs text-gray-700">当たり残り <span className="tabular-nums">{formatNumber(getBagEntryTickets(partyBags.commonRewardBag, 1))}</span></div>
                </div>
                ...
                <div>
                  ...
                  <div className="pl-3 text-xs text-gray-700">当たり残り <span className="tabular-nums">{formatNumber(getBagEntryTickets(partyBags.uncommonRewardBag, 1))}</span></div>
                </div>
                <div>
                  ...
                  <div className="pl-3 text-xs text-gray-700">当たり残り <span className="tabular-nums">{formatNumber(getBagEntryTickets(partyBags.eliteRareRewardBag, 1))}</span></div>
                </div>
                <div>
                  ...
                  <div className="pl-3 text-xs text-gray-700">当たり残り <span className="tabular-nums">{formatNumber(getBagEntryTickets(partyBags.bossRareRewardBag, 1))}</span></div>
                </div>
                <div>
                  ...
                  <div className="pl-3 text-xs text-gray-700">当たり残り <span className="tabular-nums">{formatNumber(getBagEntryTickets(partyBags.mythicRareRewardBag, 1))}</span></div>
                </div>
