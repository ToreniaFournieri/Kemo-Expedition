...
export const ENEMY_TYPE_SHORT_NAME_KEYS: Record<string, string> = {
  ...
  Caninian: 'data.races.caninian.name',
  Lupinian: 'data.races.lupinian.name',
  Vulpinian: 'data.races.vulpinian.name',
  Ursan: 'data.races.ursan.name',
  Felidian: 'data.races.felidian.name',
  Mustelid: 'data.races.mustelid.name',
  Leporian: 'data.races.leporian.name',
  Cervin: 'data.races.cervin.name',
  Procyonian: 'data.races.procyonian.name',
  Murid: 'data.races.murid.name',
};
