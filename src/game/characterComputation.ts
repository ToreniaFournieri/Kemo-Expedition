...
export function getAbilityDescription(id: AbilityId, level: number): string {
  const descriptions: Record<AbilityId, (level: number) => string> = {
    ...
    life_drain: (l) => `通常近接攻撃で相手に与えたダメージの${l >= 7 ? '100%' : l === 6 ? '30%' : l === 5 ? '10%' : l === 4 ? '3%' : l === 3 ? '1%' : l === 2 ? '0.3%' : '0.1%'}を回復`,
    ...
    flying: (l) => `近接9(開始)タイミングで発動。自身の回避+${l >= 3 ? '50' : l === 2 ? '45' : '40'}`,
    free: (l) => `${l >= 5 ? '魔法2' : l === 4 ? '魔法1' : `近接${l}` }タイミングで発動。戦闘から逃げる(戦闘は引分になる)`,
    first_aid: (l) => `各エリート戦後に、自身のHP増加基礎値とアイテムHP増加値の${l >= 5 ? '6' : l === 4 ? '5' : l === 3 ? '4' : l === 2 ? '3' : '2'}%を回復する`,
    frostbite: () => '相手の行動順番に-1を加えて遅らせる',
    ice_reflect: (l) => `自身が受ける予定の通常攻撃の氷属性ダメージを反射(${l >= 5 ? '50%' : l === 4 ? '35%' : l === 3 ? '20%' : l === 2 ? '10%' : '5%'})して相手に与える(自身もダメージ(${l >= 5 ? '50%' : l === 4 ? '65%' : l === 3 ? '80%' : l === 2 ? '90%' : '95%'})を受ける)`,
    ...
    fire_reflect: (l) => `自身が受ける予定の通常攻撃の火属性ダメージを反射(${l >= 5 ? '50%' : l === 4 ? '35%' : l === 3 ? '20%' : l === 2 ? '10%' : '5%'})して相手に与える(自身もダメージ(${l >= 5 ? '50%' : l === 4 ? '65%' : l === 3 ? '80%' : l === 2 ? '90%' : '95%'})を受ける)`,
    ...
    thunder_reflect: (l) => `自身が受ける予定の通常攻撃の雷属性ダメージを反射(${l >= 5 ? '50%' : l === 4 ? '35%' : l === 3 ? '20%' : l === 2 ? '10%' : '5%'})して相手に与える(自身もダメージ(${l >= 5 ? '50%' : l === 4 ? '65%' : l === 3 ? '80%' : l === 2 ? '90%' : '95%'})を受ける)`,
    ...
    fading_memory: () => '敵味方問わず無作為に選んだ相手のアビリティ1つをこの戦闘中無効にする',
    ...
    magical_reflect: (l) => `自身が受ける予定の通常攻撃の魔法ダメージを反射(${l >= 5 ? '50%' : l === 4 ? '35%' : l === 3 ? '20%' : l === 2 ? '10%' : '5%'})して相手に与える(自身もダメージ(${l >= 5 ? '50%' : l === 4 ? '65%' : l === 3 ? '80%' : l === 2 ? '90%' : '95%'})を受ける)`,
    ...
    ranged_reflect: (l) => `自身が受ける予定の遠距離攻撃のダメージを反射(${l >= 5 ? '50%' : l === 4 ? '35%' : l === 3 ? '20%' : l === 2 ? '10%' : '5%'})して相手に与える(自身もダメージ(${l >= 5 ? '50%' : l === 4 ? '65%' : l === 3 ? '80%' : l === 2 ? '90%' : '95%'})を受ける)`,
    ranged_null: () => '自身が受ける予定の遠距離攻撃のダメージを無効化する',
    melee_reflect: (l) => `自身が受ける予定の近接攻撃のダメージを反射(${l >= 5 ? '50%' : l === 4 ? '35%' : l === 3 ? '20%' : l === 2 ? '10%' : '5%'})して相手に与える(自身もダメージ(${l >= 5 ? '50%' : l === 4 ? '65%' : l === 3 ? '80%' : l === 2 ? '90%' : '95%'})を受ける)`,
