...
export const GOD_ENEMY_PROFILES: GodEnemyProfile[] = [
  { expId: 1, tier: 3, level: 26, name: 'Seiran', title: 'Goddess of Restoration', displayName: 'セイラン 再生の女神', enemyClass: 'pilgrim', representFor: 'Caninian', abilities: [{ id: 'resurrect', level: 2 }], dropItemTier: 3, dropItemCategories: ['grimoire', 'robe'], expedition: 'ケイナイアン平原' },
  ...
  { expId: 6, tier: 7, level: 59, name: 'Rondel', title: 'God of Resonance', displayName: 'ロンデル 共鳴の神', enemyClass: 'wizard', representFor: 'Mustelid', abilities: [{ id: 'resonance', level: 4 }], dropItemTier: 7, dropItemCategories: ['wand', 'arrow'], expedition: 'プロキオン巣穴' },
  ...
  { expId: 10, tier: 8, level: 65, name: 'Tanue', title: 'Goddess of Mirage', displayName: 'タヌエ 幻影の女神', enemyClass: 'duelist', representFor: 'Procyonian', abilities: [{ id: 'illusion', level: 1 }], dropItemTier: 8, dropItemCategories: ['sword', 'gauntlet'], expedition: '(not yet)' },
