...
export const GOD_ENEMY_PROFILES: GodEnemyProfile[] = [
  ...
  { enemyId: 9, expId: 9, tier: 8, level: 62, name: 'Skuva', title: 'God of Dusk', get displayName() { return t('masterData.god.Skuva.displayName'); }, enemyClass: 'ninja', representFor: 'Murid', abilities: [{ id: 'stealth', level: 1 }], itemIds: [8517, 8518], expedition: '(not yet)', image_path: '/enemy/E_9.png' },
