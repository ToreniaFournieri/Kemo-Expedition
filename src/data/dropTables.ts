...
export const GOD_ENEMY_PROFILES: GodEnemyProfile[] = [
  ...
  { expId: 3, tier: 5, level: 32, name: 'Kyōen', title: 'God of Cunning', displayName: 'キョウエン 狩猟の神', enemyClass: 'rogue', representFor: 'Vulpinian', abilities: [{ id: 'momentum', level: 2 }], dropItemTier: 5, dropItemCategories: ['archery', 'bolt'], expedition: 'ヴァルンの樹林帯' },
