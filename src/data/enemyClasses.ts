...
const ENEMY_CLASS_MODIFIERS: Record<EnemyClassId, EnemyClassModifier> = {
  ...
  alchemist: { hpModifier: 0.77, abilityAdd: 'arcane_stability', accuracyAdd: 0.0, evasionAdd: 0.0, rangedAttackModifier: 0.9, rangedAttackAmplifierModifier: 0.8, rangedNoA: 0, magicalAttackModifier: 1.2, magicalAttackAmplifierModifier: 1.0, magicalNoA: 5, meleeAttackModifier: 0.9, meleeAttackAmplifierModifier: 0.8, meleeNoA: 0, physicalDefenseModifier: 0.7, magicalDefenseModifier: 1.0, experienceModifier: 1.2 },
  guardian: { hpModifier: 1.43, accuracyAdd: 0.0, evasionAdd: 0.0, rangedAttackModifier: 0.9, rangedAttackAmplifierModifier: 0.8, rangedNoA: 0, magicalAttackModifier: 0.8, magicalAttackAmplifierModifier: 0.8, magicalNoA: 0, meleeAttackModifier: 0.9, meleeAttackAmplifierModifier: 0.8, meleeNoA: 2, physicalDefenseModifier: 1.2, magicalDefenseModifier: 0.6, experienceModifier: 1.0 },
  pilgrim: { hpModifier: 1.26, accuracyAdd: 0.0, evasionAdd: 0.0, rangedAttackModifier: 0.9, rangedAttackAmplifierModifier: 0.8, rangedNoA: 0, magicalAttackModifier: 0.9, magicalAttackAmplifierModifier: 0.85, magicalNoA: 2, meleeAttackModifier: 0.9, meleeAttackAmplifierModifier: 0.9, meleeNoA: 0, physicalDefenseModifier: 1.1, magicalDefenseModifier: 1.1, experienceModifier: 0.4 },
  lord: { hpModifier: 1.21, accuracyAdd: 0.0, evasionAdd: 0.0, rangedAttackModifier: 0.9, rangedAttackAmplifierModifier: 0.8, rangedNoA: 0, magicalAttackModifier: 0.9, magicalAttackAmplifierModifier: 0.8, magicalNoA: 0, meleeAttackModifier: 1.0, meleeAttackAmplifierModifier: 0.9, meleeNoA: 2, physicalDefenseModifier: 1.2, magicalDefenseModifier: 1.0, experienceModifier: 1.6 },
