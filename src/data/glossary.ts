...
export const GLOSSARY_SECTIONS: GlossarySection[] = [
  {
    ...
    "entries": [
      ...
      },
      {
        ...
        "label": "遠距離混乱1",
        "description": "遠距離1タイミングで発動。1/32確率で遠距離攻撃能力を持つ未行動の相手一人を敵対状態とする"
      },
      {
        "key": "a.ranged-confusion2",
        "label": "遠距離混乱2",
        "description": "遠距離1タイミングで発動。3/32の確率で遠距離攻撃能力を持つ未行動の相手一人を敵対状態とする"
      },
      {
        "key": "a.ranged-confusion3",
        "label": "遠距離混乱3",
        "description": "遠距離2タイミングで発動。3/32の確率で遠距離攻撃能力を持つ未行動の相手一人を敵対状態とする"
      },
      {
        "key": "a.ranged-confusion4",
        "label": "遠距離混乱4",
        "description": "遠距離2タイミングで発動。5/32の確率で遠距離攻撃能力を持つ未行動の相手一人を敵対状態とする"
      },
      {
        "key": "a.ranged-confusion5",
        "label": "遠距離混乱5",
        "description": "遠距離2タイミングで発動。7/32の確率で遠距離攻撃能力を持つ未行動の相手一人を敵対状態とする"
      },
      {
        "key": "a.magic-confusion1",
        "label": "魔法混乱1",
        "description": "魔法1タイミングで発動。1/32確率で魔法攻撃能力を持つ未行動の相手一人を敵対状態とする"
      },
      {
        "key": "a.magic-confusion2",
        "label": "魔法混乱2",
        "description": "魔法1タイミングで発動。3/32の確率で魔法攻撃能力を持つ未行動の相手一人を敵対状態とする"
      },
      {
        "key": "a.magic-confusion3",
        "label": "魔法混乱3",
        "description": "魔法2タイミングで発動。3/32の確率で魔法攻撃能力を持つ未行動の相手一人を敵対状態とする"
      },
      {
        "key": "a.magic-confusion4",
        "label": "魔法混乱4",
        "description": "魔法2タイミングで発動。5/32の確率で魔法攻撃能力を持つ未行動の相手一人を敵対状態とする"
      },
      {
        "key": "a.magic-confusion5",
        "label": "魔法混乱5",
        "description": "魔法2タイミングで発動。7/32の確率で魔法攻撃能力を持つ未行動の相手一人を敵対状態とする"
      },
      {
        "key": "a.melee-confusion1",
        "label": "近接混乱1",
        "description": "近接1タイミングで発動。1/32確率で近接攻撃能力を持つ未行動の相手一人を敵対状態とする"
      },
      {
        "key": "a.melee-confusion2",
        "label": "近接混乱2",
        "description": "近接1タイミングで発動。3/32の確率で近接攻撃能力を持つ未行動の相手一人を敵対状態とする"
      },
      {
        "key": "a.melee-confusion3",
        "label": "近接混乱3",
        "description": "近接2タイミングで発動。3/32の確率で近接攻撃能力を持つ未行動の相手一人を敵対状態とする"
      },
      {
        "key": "a.melee-confusion4",
        "label": "近接混乱4",
        "description": "近接2タイミングで発動。5/32の確率で近接攻撃能力を持つ未行動の相手一人を敵対状態とする"
      },
      {
        "key": "a.melee-confusion5",
        "label": "近接混乱5",
        "description": "近接2タイミングで発動。7/32の確率で近接攻撃能力を持つ未行動の相手一人を敵対状態とする"
      },
      {
