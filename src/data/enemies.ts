...
const ENEMY_CLASS_BASES: Record<EnemyClassId, EnemyClassBase> = {
  ...
  rogue: { hp: 30, abilities: ['deflection'], accuracyBonus: 0.06, evasionBonus: 0.06, rangedAttack: 10, rangedNoA: 4, magicalAttack: 0, magicalNoA: 0, meleeAttack: 10, meleeNoA: 4, rangedAttackAmplifier: 1.2, magicalAttackAmplifier: 1.0, meleeAttackAmplifier: 1.0, physicalDefense: 8, magicalDefense: 8, experience: 8 },
