...
const ENEMY_CLASS_BASES: Record<EnemyClassId, EnemyClassBase> = {
  ...
  wizard: { hp: 27, abilities: [], accuracyBonus: 0.0, evasionBonus: -0.15, rangedAttack: 0, rangedNoA: 0, magicalAttack: 40, magicalNoA: 2, meleeAttack: 0, meleeNoA: 0, rangedAttackAmplifier: 1.0, magicalAttackAmplifier: 1.2, meleeAttackAmplifier: 1.0, physicalDefense: 4, magicalDefense: 12, experience: 10 },
