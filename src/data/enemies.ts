...
const EXPEDITION_4_NORMALS: EnemyTemplate[] = [
  { name: '鉄鎚の熊戦士', hpMod: 1.0, attackType: 'mixed', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.2, ice: 2.0 } },
  { name: '熔岩射ちの熊射手', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.1, ice: 2.0 } },
  { name: '溶岩炉の熊術師', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.0, ice: 2.0 } },
  { name: '炉祈の熊巡礼', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.3, ice: 1.5 } },
  { name: '火影の熊奪掠者', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.2, ice: 1.8 } },
  { name: '熔岩跳びの熊影', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.2, ice: 1.8 } },
  { name: '鉄刀の熊剣士', hpMod: 1.0, attackType: 'ranged', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.3 } },
  { name: '鍛炉の熊賢者', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.1, ice: 1.8 } },
  { name: '鉄爪の熊闘士', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.0, ice: 2.0 } },
  { name: '炉座の熊領主', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.3 } },
  { name: '溶岩盾の熊守兵', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.2 } },
  { name: '火花散らす熊狙撃手', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.0, ice: 2.0 } },
  { name: '熔鉄の熊呪術師', hpMod: 1.0, attackType: 'mixed', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.1 } },
  { name: '霊峰を統べる熊公', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.2 } },
  { name: '灼鉄居合の熊侍', hpMod: 1.0, attackType: 'ranged', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.2 } },
  { name: '火走りの熊忍', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.1, ice: 1.8 } },
  { name: '炉影の熊盗賊', hpMod: 1.0, attackType: 'ranged', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.0 } },
  { name: '霊峰の熊司書', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.2 } },
  { name: '双鉄刃の熊闘将', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.3 } },
  { name: '溶岩祈の熊巡礼', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.1, ice: 1.8 } },
  { name: '鉄殻の熊重兵', hpMod: 1.0, attackType: 'mixed', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.2 } },
  { name: '熔弓の熊射手長', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.2 } },
  { name: '霊炉の熊大術師', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.2 } },
  { name: '溶岩鍛冶王熊', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.0 } },
  { name: '霊峰流・鉄刀熊剣豪', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.3 } },
  { name: '熔走の熊影将', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.0 } },
  { name: '溶鉄裂きの熊暗殺者', hpMod: 1.0, attackType: 'mixed', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.1 } },
  { name: '古炉の熊賢老', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.1 } },
  { name: '連鉄刃の熊剣鬼', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.2 } },
  { name: '炉魂の熊祈り手', hpMod: 1.0, attackType: 'mixed', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.1, ice: 1.8 } },
];

const EXPEDITION_4_ELITES: EnemyTemplate[] = [
  { name: '炉門破りの熊奪掠将', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.1, ice: 2.0 } },
  { name: '鉄壁の熊守将', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.0, ice: 2.0 } },
  { name: '火山の熊狙撃長', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.0, ice: 2.0 } },
  { name: '双鉄刃の熊闘将長', hpMod: 1.0, attackType: 'mixed', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.1, ice: 1.8 } },
  { name: '霊炉結界の熊大術師長', hpMod: 1.0, attackType: 'mixed', attackMod: 1.0, defenseMod: 1.0, element: 'fire', resistances: { fire: 0.1, ice: 1.8 } },
];
...
const EXPEDITION_5_NORMALS: EnemyTemplate[] = [
  { name: '月光鎧の猫兵', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.0, fire: 2.0 } },
  { name: '光苔射ちの猫射手', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.1, fire: 2.0 } },
  { name: '燐光の猫術師', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.2, fire: 1.8 } },
  { name: '聖茂の猫巡礼', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.3 } },
  { name: '葉影の猫盗賊', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.1, fire: 1.8 } },
  { name: '月影跳びの猫影', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.2 } },
  { name: '月刃の猫剣士', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.2 } },
  { name: '光苔文の猫賢者', hpMod: 1.0, attackType: 'ranged', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.3 } },
  { name: '双月刃の猫闘士', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.2, fire: 1.8 } },
  { name: '聖域の猫領主', hpMod: 1.0, attackType: 'ranged', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.2 } },
  { name: '月光盾の猫守兵', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.2 } },
  { name: '燐弾連射の猫狙撃手', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.1 } },
  { name: '月幻の猫呪術師', hpMod: 1.0, attackType: 'ranged', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.3 } },
  { name: '古遺跡の猫族長', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.1, fire: 2.0 } },
  { name: '月断ちの猫侍', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.1 } },
  { name: '燐歩きの猫忍', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.3 } },
  { name: '茂影の猫奪掠者', hpMod: 1.0, attackType: 'mixed', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.2 } },
  { name: '遺跡司書の猫賢者', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.2 } },
  { name: '連月刃の猫闘将', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.2 } },
  { name: '月祈の猫巡礼', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.0, fire: 1.8 } },
  { name: '聖域重装の猫衛士', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.2 } },
  { name: '閃撃の猫射手長', hpMod: 1.0, attackType: 'mixed', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.2 } },
  { name: '月輝の猫大術師', hpMod: 1.0, attackType: 'mixed', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.1, fire: 1.8 } },
  { name: '月庭を統べる猫公', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.0 } },
  { name: '月影居合の猫剣豪', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.3 } },
  { name: '閃走の猫影将', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.2 } },
  { name: '燐裂きの猫暗殺者', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.2 } },
  { name: '聖茂の猫賢老', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.1 } },
  { name: '双月連刃の猫剣鬼', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.2 } },
  { name: '聖域の猫祈り手', hpMod: 1.0, attackType: 'mixed', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.1, fire: 1.8 } },
];

const EXPEDITION_5_ELITES: EnemyTemplate[] = [
  { name: '月門破りの猫奪掠将', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.1, fire: 2.0 } },
  { name: '聖茂の月光守将', hpMod: 1.0, attackType: 'mixed', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.0, fire: 2.0 } },
  { name: '燐弾嵐の猫狙撃長', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.0, fire: 2.0 } },
  { name: '双月刃の猫剣闘長', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.1, fire: 2.0 } },
  { name: '月輝結界の猫大術師長', hpMod: 1.0, attackType: 'mixed', attackMod: 1.0, defenseMod: 1.0, element: 'ice', resistances: { ice: 0.0, fire: 2.0 } },
];
