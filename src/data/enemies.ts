...
const EXPEDITION_2_NORMALS: EnemyTemplate[] = [
  ...
  { name: '磨刃の断崖侍', hpMod: 1.0, attackType: 'ranged', attackMod: 1.0, defenseMod: 1.0 },
...
const EXPEDITION_3_NORMALS: EnemyTemplate[] = [
  ...
  { name: '青銅刃の狐侍', hpMod: 1.0, attackType: 'magical', attackMod: 1.0, defenseMod: 1.0 },
...
const EXPEDITION_4_NORMALS: EnemyTemplate[] = [
  ...
  { name: '鉄刀の熊侍', hpMod: 1.0, attackType: 'ranged', attackMod: 1.0, defenseMod: 1.0 },
...
const EXPEDITION_5_NORMALS: EnemyTemplate[] = [
  ...
  { name: '月刃の猫侍', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0 },
...
const EXPEDITION_6_NORMALS: EnemyTemplate[] = [
  ...
  { name: '銅刃の鼬侍', hpMod: 1.0, attackType: 'ranged', attackMod: 1.0, defenseMod: 1.0 },
...
const EXPEDITION_7_NORMALS: EnemyTemplate[] = [
  ...
  { name: '天刃の兎侍', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0 },
...
const EXPEDITION_8_NORMALS: EnemyTemplate[] = [
  ...
  { name: '時断ちの鹿侍', hpMod: 1.0, attackType: 'melee', attackMod: 1.0, defenseMod: 1.0 },
...
const ENEMY_CLASS_BASES: Record<EnemyClassId, EnemyClassBase> = {
  fighter: { hp: 63, abilities: [], accuracyBonus: 0.0, evasionBonus: 0.02, rangedAttack: 0, rangedNoA: 0, magicalAttack: 0, magicalNoA: 0, meleeAttack: 32, meleeNoA: 2, rangedAttackAmplifier: 1.0, magicalAttackAmplifier: 1.0, meleeAttackAmplifier: 1.0, physicalDefense: 13, magicalDefense: 10, experience: 10 },
  duelist: { hp: 50, abilities: ['counter'], accuracyBonus: 0.01, evasionBonus: 0.01, rangedAttack: 0, rangedNoA: 0, magicalAttack: 0, magicalNoA: 0, meleeAttack: 40, meleeNoA: 4, rangedAttackAmplifier: 1.0, magicalAttackAmplifier: 1.0, meleeAttackAmplifier: 1.2, physicalDefense: 10, magicalDefense: 10, experience: 10 },
  ninja: { hp: 46, abilities: ['re_attack'], accuracyBonus: 0.0, evasionBonus: 0.04, rangedAttack: 0, rangedNoA: 0, magicalAttack: 0, magicalNoA: 0, meleeAttack: 48, meleeNoA: 4, rangedAttackAmplifier: 1.0, magicalAttackAmplifier: 1.0, meleeAttackAmplifier: 1.2, physicalDefense: 9, magicalDefense: 8, experience: 14 },
  samurai: { hp: 40, abilities: ['iaigiri'], accuracyBonus: -0.05, evasionBonus: -0.01, rangedAttack: 0, rangedNoA: 0, magicalAttack: 0, magicalNoA: 0, meleeAttack: 75, meleeNoA: 1, rangedAttackAmplifier: 1.0, magicalAttackAmplifier: 1.0, meleeAttackAmplifier: 1.3, physicalDefense: 8, magicalDefense: 8, experience: 12 },
  lord: { hp: 58, abilities: [], accuracyBonus: 0.0, evasionBonus: 0.0, rangedAttack: 0, rangedNoA: 0, magicalAttack: 0, magicalNoA: 0, meleeAttack: 32, meleeNoA: 4, rangedAttackAmplifier: 1.0, magicalAttackAmplifier: 1.0, meleeAttackAmplifier: 1.1, physicalDefense: 12, magicalDefense: 12, experience: 20 },
  ranger: { hp: 44, abilities: [], accuracyBonus: 0.03, evasionBonus: 0.01, rangedAttack: 28, rangedNoA: 4, magicalAttack: 0, magicalNoA: 0, meleeAttack: 0, meleeNoA: 0, rangedAttackAmplifier: 1.2, magicalAttackAmplifier: 1.0, meleeAttackAmplifier: 1.0, physicalDefense: 9, magicalDefense: 8, experience: 12 },
  wizard: { hp: 27, abilities: ['resonance'], accuracyBonus: 0.0, evasionBonus: -0.015, rangedAttack: 0, rangedNoA: 0, magicalAttack: 40, magicalNoA: 2, meleeAttack: 0, meleeNoA: 0, rangedAttackAmplifier: 1.0, magicalAttackAmplifier: 1.2, meleeAttackAmplifier: 1.0, physicalDefense: 4, magicalDefense: 12, experience: 10 },
  sage: { hp: 47, abilities: [], accuracyBonus: 0.0, evasionBonus: 0.0, rangedAttack: 0, rangedNoA: 0, magicalAttack: 20, magicalNoA: 4, meleeAttack: 0, meleeNoA: 0, rangedAttackAmplifier: 1.0, magicalAttackAmplifier: 1.2, meleeAttackAmplifier: 1.0, physicalDefense: 9, magicalDefense: 13, experience: 10 },
  rogue: { hp: 40, abilities: ['deflection', 'first_strike'], accuracyBonus: 0.06, evasionBonus: 0.06, rangedAttack: 20, rangedNoA: 4, magicalAttack: 0, magicalNoA: 0, meleeAttack: 20, meleeNoA: 4, rangedAttackAmplifier: 1.2, magicalAttackAmplifier: 1.0, meleeAttackAmplifier: 1.0, physicalDefense: 8, magicalDefense: 8, experience: 8 },
  pilgrim: { hp: 62, abilities: ['null_counter'], accuracyBonus: 0.0, evasionBonus: 0.02, rangedAttack: 0, rangedNoA: 0, magicalAttack: 20, magicalNoA: 2, meleeAttack: 32, meleeNoA: 2, rangedAttackAmplifier: 1.0, magicalAttackAmplifier: 1.2, meleeAttackAmplifier: 1.2, physicalDefense: 11, magicalDefense: 11, experience: 16 },
};
