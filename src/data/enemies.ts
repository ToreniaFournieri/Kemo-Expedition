...
const ENEMY_CLASS_BASES: Record<EnemyClassId, EnemyClassBase> = {
  ...
  ninja: { hp: 47, abilities: ['re_attack'], accuracyBonus: 0.0, evasionBonus: 0.04, rangedAttack: 0, rangedNoA: 0, magicalAttack: 0, magicalNoA: 0, meleeAttack: 24, meleeNoA: 4, rangedAttackAmplifier: 1.0, magicalAttackAmplifier: 1.0, meleeAttackAmplifier: 1.2, physicalDefense: 9, magicalDefense: 8, experience: 14 },
  ...
  rogue: { hp: 30, abilities: ['deflection', 'first_strike'], accuracyBonus: 0.06, evasionBonus: 0.06, rangedAttack: 10, rangedNoA: 4, magicalAttack: 0, magicalNoA: 0, meleeAttack: 10, meleeNoA: 4, rangedAttackAmplifier: 1.2, magicalAttackAmplifier: 1.0, meleeAttackAmplifier: 1.0, physicalDefense: 8, magicalDefense: 8, experience: 8 },
