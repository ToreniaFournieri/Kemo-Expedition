...
export const SUPER_RARE_TITLES: SuperRareTitle[] = [
  { value: 0, title: '', tickets: 399920, multiplier: 1.0, bonuses: [] },
  ...
  { value: 11, title: '守護の', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'defender', abilityLevel: 2 }, { type: 'physical_attack', value: 0.1 }] },
  { value: 12, title: '前線を貫く', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'defender', abilityLevel: 2 }, { type: 'penet', value: 0.04 }] },
  { value: 13, title: '執着し', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'counter', abilityLevel: 2 }, { type: 'evasion', value: 0.01 }] },
  { value: 14, title: '煌めく', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'counter', abilityLevel: 2 }, { type: 'magical_attack', value: 0.3 }] },
  { value: 15, title: '華麗なる', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 're_attack', abilityLevel: 2 }, { type: 'mind', value: 1 }] },
  { value: 16, title: '闇駆ける', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 're_attack', abilityLevel: 2 }, { type: 'magical_attack', value: 0.3 }] },
  { value: 17, title: '抜刀の', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'iaigiri', abilityLevel: 2 }, { type: 'intelligence', value: 1 }] },
  { value: 18, title: '一太刀を制す', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'iaigiri', abilityLevel: 2 }, { type: 'magical_defense_multiplier_xV', value: 3 / 5 }] },
  { value: 19, title: '鼓舞し', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'command', abilityLevel: 2 }, { type: 'magical_attack', value: 0.1 }] },
  { value: 20, title: '王道なる', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'command', abilityLevel: 2 }, { type: 'penet', value: 0.08 }] },
  { value: 21, title: '狙いし', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'hunter', abilityLevel: 2 }, { type: 'magical_attack', value: 0.1 }] },
  { value: 22, title: '獲物を追う', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'hunter', abilityLevel: 2 }, { type: 'evasion', value: 0.015 }] },
  { value: 23, title: '響き渡る', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'resonance', abilityLevel: 2 }, { type: 'vitality', value: 1 }] },
  { value: 24, title: '唱えし', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'resonance', abilityLevel: 2 }, { type: 'magical_defense_multiplier_xV', value: 0.9 }] },
  { value: 25, title: '障壁の', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'm_barrier', abilityLevel: 2 }, { type: 'strength', value: 1 }] },
  { value: 26, title: '理の', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'm_barrier', abilityLevel: 2 }, { type: 'physical_defense_multiplier_xV', value: 3 / 5 }] },
  { value: 27, title: '風切り躱す', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'deflection', abilityLevel: 2 }, { type: 'magical_attack', value: 0.1 }] },
  { value: 28, title: '影に溶ける', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'deflection', abilityLevel: 2 }, { type: 'physical_attack', value: 0.3 }] },
  { value: 29, title: '節制の', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'null_counter', abilityLevel: 2 }, { type: 'accuracy', value: 0.015 }] },
  { value: 30, title: '祈りし', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'null_counter', abilityLevel: 2 }, { type: 'physical_attack', value: 0.3 }] },
  { value: 31, title: '探し求めた', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'seeker', abilityLevel: 2 }, { type: 'penet', value: 0.04 }] },
  { value: 32, title: '修復されし', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'resurrect', abilityLevel: 2 }, { type: 'physical_attack', value: 0.2 }] },
  { value: 33, title: '一気呵成', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'rage', abilityLevel: 2 }, { type: 'fire_offense', value: 0.1 }] },
  { value: 34, title: '起き上がる', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 're_counter', abilityLevel: 2 }, { type: 'magical_defense_multiplier_xV', value: 0.9 }] },
  { value: 35, title: '始まりの', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'momentum', abilityLevel: 2 }, { type: 'accuracy', value: 0.015 }] },
  { value: 36, title: '狡知を巡らす', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'cunning', abilityLevel: 2 }, { type: 'penet', value: 0.04 }] },
  { value: 37, title: '背を預ける', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'bulwark', abilityLevel: 2 }, { type: 'penet', value: 0.08 }] },
  { value: 38, title: '機械化し', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'cyborgization', abilityLevel: 2 }, { type: 'physical_defense_multiplier_xV', value: 0.9 }] },
  { value: 39, title: '先を行く', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'first_strike', abilityLevel: 2 }, { type: 'thunder_offense', value: 0.1 }] },
  { value: 40, title: '連携し', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'covering_fire', abilityLevel: 2 }, { type: 'magical_attack', value: 0.2 }] },
  { value: 41, title: '共感し', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'resonance', abilityLevel: 2 }, { type: 'physical_attack', value: 0.1 }] },
  { value: 42, title: '渡り歩く', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'peddler', abilityLevel: 2 }, { type: 'magical_attack', value: 0.1 }] },
  { value: 43, title: '冷酷なる', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'composure', abilityLevel: 2 }, { type: 'ice_offense', value: 0.1 }] },
  { value: 44, title: '反射する', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'magical_counter', abilityLevel: 2 }, { type: 'physical_attack', value: 0.2 }] },
  { value: 45, title: '研ぎ澄ます', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'focus', abilityLevel: 2 }, { type: 'magical_attack', value: 0.2 }] },
  { value: 46, title: '未来を変える', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'prophecy', abilityLevel: 2 }, { type: 'physical_attack', value: 0.1 }] },
  { value: 47, title: '影に消える', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'stealth', abilityLevel: 2 }, { type: 'evasion', value: 0.015 }] },
  { value: 48, title: '駆け巡る', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'first_strike', abilityLevel: 2 }, { type: 'accuracy', value: 0.015 }] },
  { value: 49, title: '化けた', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'illusion', abilityLevel: 2 }, { type: 'evasion', value: 0.01 }] },
  { value: 50, title: '原初の', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ability', value: 1, abilityId: 'illusion', abilityLevel: 2 }, { type: 'penet', value: 0.04 }] },
  { value: 51, title: '火焔の', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'fire_offense', value: 0.3 }, { type: 'accuracy', value: 0.01 }] },
  { value: 52, title: '氷晶纏いし', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ice_offense', value: 0.3 }, { type: 'physical_defense_multiplier_xV', value: 0.9 }] },
  { value: 53, title: '電光帯びし', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'thunder_offense', value: 0.3 }, { type: 'magical_defense_multiplier_xV', value: 0.9 }] },
  { value: 54, title: '炎を躱す', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'fire_defense_multiplier_xV', value: 3 / 5 }, { type: 'evasion', value: 0.01 }] },
  { value: 55, title: '氷結砕きし', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ice_defense_multiplier_xV', value: 3 / 5 }, { type: 'magical_attack', value: 0.1 }] },
  { value: 56, title: '電光いなす', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'thunder_defense_multiplier_xV', value: 3 / 5 }, { type: 'physical_attack', value: 0.1 }] },
  { value: 57, title: '灼熱なる', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'fire_offense', value: 0.2 }, { type: 'ice_defense_multiplier_xV', value: 3 / 5 }] },
  { value: 58, title: '冷徹なる', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ice_offense', value: 0.2 }, { type: 'thunder_defense_multiplier_xV', value: 3 / 5 }] },
  { value: 59, title: '天衝く', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'thunder_offense', value: 0.2 }, { type: 'fire_defense_multiplier_xV', value: 3 / 5 }] },
  { value: 60, title: '氷炎踊る', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'ice_defense_multiplier_xV', value: 3 / 5 }, { type: 'fire_defense_multiplier_xV', value: 3 / 5 }] },
  { value: 61, title: '護られし', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'armor_multiplier', value: 1.1 }, { type: 'accuracy', value: 0.01 }] },
  { value: 62, title: '舞い踊る', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'robe_multiplier', value: 1.1 }, { type: 'magical_defense_multiplier_xV', value: 0.9 }] },
  { value: 63, title: '盾影に射る', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'shield_multiplier', value: 1.1 }, { type: 'physical_attack', value: 0.2 }] },
  { value: 64, title: '剣影に舞う', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'sword_multiplier', value: 1.1 }, { type: 'evasion', value: 0.01 }] },
  { value: 65, title: '一閃に至る', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'katana_multiplier', value: 1.1 }, { type: 'physical_defense_multiplier_xV', value: 0.9 }] },
  { value: 66, title: '慟哭し', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'gauntlet_multiplier', value: 1.1 }, { type: 'magical_attack', value: 0.2 }] },
  { value: 67, title: '矢で導く', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'arrow_multiplier', value: 1.1 }, { type: 'magical_attack', value: 0.2 }] },
  { value: 68, title: '弩級の', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'bolt_multiplier', value: 1.1 }, { type: 'physical_defense_multiplier_xV', value: 0.9 }] },
  { value: 69, title: '仇なす', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'archery_multiplier', value: 1.1 }, { type: 'accuracy', value: 0.01 }] },
  { value: 70, title: '妖護りし', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'wand_multiplier', value: 1.1 }, { type: 'magical_defense_multiplier_xV', value: 0.9 }] },
  { value: 71, title: '秘められし', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'grimoire_multiplier', value: 1.1 }, { type: 'physical_defense_multiplier_xV', value: 0.9 }] },
  { value: 72, title: '許されぬ', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'catalyst_multiplier', value: 1.1 }, { type: 'physical_attack', value: 0.2 }] },
  { value: 73, title: '討ち抜く', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'physical_offense_multiplier_xV', value: 1.4 }, { type: 'evasion', value: -0.005 }] },
  { value: 74, title: '魔極めし', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'magical_offense_multiplier_xV', value: 1.4 }, { type: 'accuracy', value: -0.005 }] },
  { value: 75, title: '牙剝く', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'physical_offense_multiplier_xV', value: 1.2 }, { type: 'magical_offense_multiplier_xV', value: 1.2 }] },
  { value: 76, title: '深淵を覗く', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'magical_attack', value: 0.4 }, { type: 'physical_attack', value: 0.1 }] },
  { value: 77, title: '疾風の如く', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'physical_attack', value: 0.4 }, { type: 'evasion', value: 0.01 }] },
  { value: 78, title: '祝福されし', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'physical_defense_multiplier_xV', value: 3 / 5 }, { type: 'magical_defense_multiplier_xV', value: 3 / 5 }] },
  { value: 79, title: '災いもたらす', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'growth_xV', value: 0.9 }, { type: 'magical_offense_multiplier_xV', value: 1.5 }] },
  { value: 80, title: '呪われし', tickets: 1, multiplier: 2.0, bonuses: [{ type: 'antagonism', value: 1 }, { type: 'growth_xV', value: 1.8 }] },
];
...
const MASTER_ITEM_NAMES: MasterItemNameTable = {
  1: {
    ...
    uncommon: {
      ...
      armor: ['硬革の鎧'],
      arrow: ['黒曜石の炎矢', '黒曜石の氷矢'],
      bolt: ['黒曜尖石の弩矢', '骨鏃仕込みの弩矢'],
      catalyst: ['琥珀粉の触媒'],
      gauntlet: ['獣皮縫いのガントレット', '黒曜石縁のガントレット'],
      grimoire: ['洞窟壁画の呪頁'],
      katana: ['黒曜石縁の太刀', '獣骨柄の太刀'],
      robe: ['苔縫いの法衣'],
      shield: ['骨枠の盾'],
      sword: ['黒曜石の短剣', '牙のナイフ'],
      wand: ['精霊樹の杖'],
  ...
  2: {
    ...
    uncommon: {
      ...
      bolt: ['黒曜尖石の重弩矢', '磁石砂仕込みの弩矢'],
      catalyst: ['磁石砂の触媒'],
      gauntlet: ['磨石縁のガントレット', '黒岩補強のガントレット'],
      grimoire: ['断崖壁画の呪典'],
      katana: ['磨石鍛えの太刀', '黒岩鍛えの太刀'],
      robe: ['霧染みの法衣'],
      shield: ['黒岩の重盾'],
      sword: ['黒曜石の石刃', '磨石の石剣'],
      wand: ['風刻みの石杖'],
  ...
  3: {
    ...
    uncommon: {
      ...
      bolt: ['幻裂きの青銅弩矢', '霧研ぎの精密弩矢'],
      catalyst: ['霧精粉の触媒'],
      gauntlet: ['狐紋刻みの青銅籠手', '霧鍛えの青銅籠手'],
      grimoire: ['幻霧の秘呪書'],
      katana: ['狐紋刻みの青銅太刀', '霧鍛えの青銅太刀'],
      robe: ['幻術師の法衣'],
      shield: ['霧払いの青銅盾'],
  ...
  4: {
    ...
    uncommon: {
      ...
      bolt: ['火花裂きの鉄弩矢', '焼入れ鉄の重弩矢'],
      catalyst: ['熔核粉の触媒'],
      gauntlet: ['火入れ鉄の戦闘籠手', '霊峰鍛冶の籠手'],
      grimoire: ['鍛炉秘伝の呪典'],
      katana: ['火入れ鍛鉄の太刀', '霊峰鍛冶の太刀'],
      robe: ['炉祈司の法衣'],
      shield: ['熔鉄守護の大盾'],
      sword: ['鍛冶師の鉄剣', '火入れの鉄刃'],
      wand: ['霊炉導きの鉄杖'],
  ...
  5: {
    ...
    uncommon: {
      ...
      bolt: ['閃撃の月鋼弩矢', '燐鋼精錬の重弩矢'],
      catalyst: ['燐精核の触媒'],
      gauntlet: ['燐鋼鍛えの籠手', '聖域刻印の月鋼籠手'],
      grimoire: ['月影秘儀書'],
      katana: ['燐鋼鍛えの太刀', '聖域刻印の月鋼太刀'],
      robe: ['燐光司祭の法衣'],
      shield: ['月輝守護の大盾'],
      sword: ['月鋼細工の剣', '聖域鍛えの剣'],
      wand: ['月導の霊杖'],
  ...
  6: {
    ...
    uncommon: {
      ...
      bolt: ['貫孔加工の精密弩矢', '滑車補助の高速弩矢'],
      catalyst: ['中和強化触媒'],
      gauntlet: ['歯車補助の戦闘籠手', '耐圧配管の機械籠手'],
      grimoire: ['迷宮制御の秘呪書'],
      katana: ['歯車補助の合金太刀', '耐圧配管の機装太刀'],
      robe: ['毒気遮断の法衣'],
      shield: ['蒸気遮断の機械盾'],
    ...
    mythic: {
      ...
      bolt: ['迷宮中枢破壊の原初弩矢'],
      catalyst: ['深層反応炉の原初触媒'],
      gauntlet: ['主機核装拳・アルケミトロン'],
      grimoire: ['銅迷宮の設計原典'],
      katana: ['主機核斬装・アルケミブレード'],
    },
  },
  7: {
    common: {
    ...
    uncommon: {
      ...
      bolt: ['旋風穿ちの鋼弩矢', '高天鍛えの精密弩矢'],
      catalyst: ['高天触媒核'],
      gauntlet: ['風紋刻みの戦闘籠手', '浮島守護の天鋼籠手'],
      grimoire: ['風律の秘呪書'],
      katana: ['風紋刻みの天鋼太刀', '浮島鍛冶の霊太刀'],
      robe: ['天輝司祭の法衣'],
      shield: ['風護りの大盾'],
      sword: ['天鋼精鍛の剣', '風紋刻みの剣'],
      wand: ['天導の霊杖'],
  ...
  8: {
    ...
    uncommon: {
      ...
      bolt: ['層界穿ちの結晶弩矢', '次元鋼精錬の弩矢'],
      catalyst: ['次元安定の触媒核'],
      gauntlet: ['次元紋刻みの籠手', '時晶精鍛の戦闘籠手'],
      grimoire: ['終焉律法の秘呪書'],
      katana: ['次元紋刻みの太刀', '時晶精鍛の霊太刀'],
      robe: ['無音司祭の法衣'],
      shield: ['時壁守護の大盾'],
