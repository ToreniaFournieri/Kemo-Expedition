...
export const BONUS_ABILITY_GLOSSARY_ENTRIES: BonusAbilityGlossaryEntry[] = [
  ...
  { abilityId: 'flying', label: '飛行', description: '近接開始タイミングで発動し、自身の回避を+Nする', levelScale: ['Lv1: 40', 'Lv2: 45', 'Lv3: 50'], subcategory: 'timed', phase: 'CLOSE', priority: 9 },
  ...
  { abilityId: 'life_drain', label: '吸血', description: '通常近接攻撃で与えたダメージのNを回復する', levelScale: ['Lv1: 0.1%', 'Lv2: 0.3%', 'Lv3: 1%', 'Lv4: 3%', 'Lv5: 10%', 'Lv6: 30%', 'Lv7: 100%'], subcategory: 'reactive' },
  ...
  { abilityId: 'ice_reflect', label: '氷結反射', description: '自身が受ける予定の通常攻撃の氷属性ダメージのNを反射して相手に与える(自身は残りを受ける)', levelScale: ['Lv1: 反射5%・被弾95%', 'Lv2: 反射10%・被弾90%', 'Lv3: 反射20%・被弾80%', 'Lv4: 反射35%・被弾65%', 'Lv5: 反射50%・被弾50%'], subcategory: 'timed' },
  { abilityId: 'fire_reflect', label: '火炎反射', description: '自身が受ける予定の通常攻撃の火属性ダメージのNを反射して相手に与える(自身は残りを受ける)', levelScale: ['Lv1: 反射5%・被弾95%', 'Lv2: 反射10%・被弾90%', 'Lv3: 反射20%・被弾80%', 'Lv4: 反射35%・被弾65%', 'Lv5: 反射50%・被弾50%'], subcategory: 'timed' },
  { abilityId: 'thunder_reflect', label: '雷撃反射', description: '自身が受ける予定の通常攻撃の雷属性ダメージのNを反射して相手に与える(自身は残りを受ける)', levelScale: ['Lv1: 反射5%・被弾95%', 'Lv2: 反射10%・被弾90%', 'Lv3: 反射20%・被弾80%', 'Lv4: 反射35%・被弾65%', 'Lv5: 反射50%・被弾50%'], subcategory: 'timed' },
  { abilityId: 'magical_reflect', label: '魔法反射', description: '自身が受ける予定の通常攻撃の魔法ダメージのNを反射して相手に与える(自身は残りを受ける)', levelScale: ['Lv1: 反射5%・被弾95%', 'Lv2: 反射10%・被弾90%', 'Lv3: 反射20%・被弾80%', 'Lv4: 反射35%・被弾65%', 'Lv5: 反射50%・被弾50%'], subcategory: 'timed' },
  { abilityId: 'ranged_reflect', label: '矢返し', description: '自身が受ける予定の遠距離攻撃ダメージをNに分散する', levelScale: ['Lv1: 反射5%・被弾95%', 'Lv2: 反射10%・被弾90%', 'Lv3: 反射20%・被弾80%', 'Lv4: 反射35%・被弾65%', 'Lv5: 反射50%・被弾50%'], subcategory: 'timed' },
  { abilityId: 'melee_reflect', label: '打ち返し', description: '自身が受ける予定の近接攻撃ダメージのNを反射して相手に与える(自身は残りを受ける)', levelScale: ['Lv1: 反射5%・被弾95%', 'Lv2: 反射10%・被弾90%', 'Lv3: 反射20%・被弾80%', 'Lv4: 反射35%・被弾65%', 'Lv5: 反射50%・被弾50%'], subcategory: 'timed' },
