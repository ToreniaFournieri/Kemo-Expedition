...
export const LINEAGES: Lineage[] = [
  { id: 'sandstorm', name: '砂塵の系譜', shortName: '砂', category: '動乱', selectable: true, bonuses: [{ type: 'ability', value: 1, abilityId: 'null_corrode', abilityLevel: 1 }, { type: 'sword_multiplier', value: 1.2 }, { type: 'grimoire_multiplier', value: 1.2 }] },
  { id: 'ashen_capital', name: '灰都の系譜', shortName: '灰', category: '動乱', selectable: true, bonuses: [{ type: 'ability', value: 1, abilityId: 'null_life_drain', abilityLevel: 1 }, { type: 'katana_multiplier', value: 1.2 }, { type: 'arrow_multiplier', value: 1.2 }] },
  { id: 'blaze_peak', name: '焔嶺の系譜', shortName: '焔', category: '動乱', selectable: true, bonuses: [{ type: 'ability', value: 1, abilityId: 'null_burn', abilityLevel: 1 }, { type: 'gauntlet_multiplier', value: 1.2 }, { type: 'armor_multiplier', value: 1.2 }, { type: 'fire_defense_multiplier_xV', value: 4 / 5 }] },
  { id: 'abyssal_sea', name: '深海の系譜', shortName: '海', category: '狩猟', selectable: true, bonuses: [{ type: 'ability', value: 1, abilityId: 'null_bind', abilityLevel: 1 }, { type: 'arrow_multiplier', value: 1.2 }, { type: 'catalyst_multiplier', value: 1.2 }] },
  { id: 'firmament', name: '天穹の系譜', shortName: '穹', category: '狩猟', selectable: true, bonuses: [{ type: 'ability', value: 1, abilityId: 'siege', abilityLevel: 1 }, { type: 'bolt_multiplier', value: 1.2 }, { type: 'shield_multiplier', value: 1.2 }] },
  { id: 'frozen_forest', name: '凍森の系譜', shortName: '凍', category: '狩猟', selectable: true, bonuses: [{ type: 'ability', value: 1, abilityId: 'coldproof', abilityLevel: 1 }, { type: 'archery_multiplier', value: 1.2 }, { type: 'robe_multiplier', value: 1.2 }, { type: 'ice_defense_multiplier_xV', value: 4 / 5 }] },
  { id: 'utopia', name: '桃源の系譜', shortName: '桃', category: '学識', selectable: true, bonuses: [{ type: 'ability', value: 1, abilityId: 'null_death_touch', abilityLevel: 1 }, { type: 'wand_multiplier', value: 1.2 }, { type: 'bolt_multiplier', value: 1.2 }] },
  ...
  { id: 'adaptation', name: '適応の系譜', shortName: '適', category: '学識', selectable: true, bonuses: [{ type: 'catalyst_multiplier', value: 1.2 }, { type: 'archery_multiplier', value: 1.2 }, { type: 'evasion', value: 0.02 }, { type: 'thunder_defense_multiplier_xV', value: 3 / 4 }] },
  { id: 'fragment', name: '断章の系譜', shortName: '断', category: '生存', selectable: true, bonuses: [{ type: 'ability', value: 1, abilityId: 'unforgettable', abilityLevel: 1 }, { type: 'armor_multiplier', value: 1.2 }, { type: 'wand_multiplier', value: 1.2 }] },
  { id: 'windcross', name: '風渡の系譜', shortName: '風', category: '生存', selectable: true, bonuses: [{ type: 'ability', value: 1, abilityId: 'wind_rider', abilityLevel: 1 }, { type: 'robe_multiplier', value: 1.2 }, { type: 'katana_multiplier', value: 1.2 }] },
  { id: 'oath', name: '誓約の系譜', shortName: '誓', category: '生存', selectable: true, bonuses: [{ type: 'ability', value: 1, abilityId: 'requiem', abilityLevel: 1 }, { type: 'shield_multiplier', value: 1.2 }, { type: 'sword_multiplier', value: 1.2 }] },
