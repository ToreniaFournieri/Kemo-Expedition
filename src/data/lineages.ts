...
export const LINEAGES: Lineage[] = [
  ...
  { id: 'frozen_forest', name: '凍森の系譜', shortName: '凍', category: '狩猟', selectable: true, bonuses: [{ type: 'ability', value: 1, abilityId: 'frostbite', abilityLevel: 1 }, { type: 'archery_multiplier', value: 1.2 }, { type: 'robe_multiplier', value: 1.2 }, { type: 'ice_defense_multiplier_xV', value: 4 / 5 }] },
