...
export const LINEAGES: Lineage[] = [
  { id: 'sandstorm', name: '砂塵の系譜', shortName: '砂', category: '動乱', selectable: true, bonuses: [{ type: 'sword_multiplier', value: 1.2 }, { type: 'grimoire_multiplier', value: 1.2 }] },
  { id: 'ashen_capital', name: '灰都の系譜', shortName: '灰', category: '動乱', selectable: true, bonuses: [{ type: 'katana_multiplier', value: 1.2 }, { type: 'arrow_multiplier', value: 1.2 }] },
  { id: 'blaze_peak', name: '焔嶺の系譜', shortName: '焔', category: '動乱', selectable: true, bonuses: [{ type: 'gauntlet_multiplier', value: 1.2 }, { type: 'armor_multiplier', value: 1.2 }, { type: 'fire_defense_multiplier_xV', value: 4 / 5 }] },
  { id: 'abyssal_sea', name: '深海の系譜', shortName: '海', category: '狩猟', selectable: true, bonuses: [{ type: 'arrow_multiplier', value: 1.2 }, { type: 'catalyst_multiplier', value: 1.2 }] },
  ...
  { id: 'oath', name: '誓約の系譜', shortName: '誓', category: '生存', selectable: true, bonuses: [{ type: 'shield_multiplier', value: 1.2 }, { type: 'sword_multiplier', value: 1.2 }] },
